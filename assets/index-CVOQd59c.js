 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vp={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Np=500,Op=600,Lp="_blank",Mp="http://localhost";class fu{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function xp(n,e,t,r=Np,s=Op){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),a=Math.max((window.screen.availWidth-r)/2,0).toString();let c="";const l=Object.assign(Object.assign({},Vp),{width:r.toString(),height:s.toString(),top:i,left:a}),d=Te().toLowerCase();t&&(c=Vc(d)?Lp:t),kc(d)&&(e=e||Mp,l.scrollbars="yes");const m=Object.entries(l).reduce((w,[S,P])=>`${w}${S}=${P},`,"");if(im(d)&&c!=="_self")return Fp(e||"",c),new fu(null);const y=window.open(e||"",c,m);M(y,n,"popup-blocked");try{y.focus()}catch{}return new fu(y)}function Fp(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rs{constructor(){this._=void 0}}function qg(n,e,t){return n instanceof Zn?function(s,i){const a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&io(i)&&(i=Ts(i)),i&&(a.fields.__previous_value__=i),{mapValue:a}}(t,e):n instanceof er?Cl(n,e):n instanceof tr?Pl(n,e):function(s,i){const a=bl(s,i),c=Vu(a)+Vu(s.Pe);return Vi(a)&&Vi(s.Pe)?Sl(c):co(s.serializer,c)}(n,e)}function jg(n,e,t){return n instanceof er?Cl(n,e):n instanceof tr?Pl(n,e):t}function bl(n,e){return n instanceof us?function(r){return Vi(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class Zn extends Rs{}class er extends Rs{constructor(e){super(),this.elements=e}}function Cl(n,e){const t=kl(e);for(const r of n.elements)t.some(s=>je(s,r))||t.push(r);return{arrayValue:{values:t}}}class tr extends Rs{constructor(e){super(),this.elements=e}}function Pl(n,e){let t=kl(e);for(const r of n.elements)t=t.filter(s=>!je(s,r));return{arrayValue:{values:t}}}class us extends Rs{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Vu(n){return re(n.integerValue||n.doubleValue)}function kl(n){return oo(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
