 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Om(r,e,t=!1){const{auth:n}=r;if(xe(n.app))return Promise.reject(Ye(n));const s="reauthenticate";try{const i=await Kn(r,$c(n,s,e,r),t);M(i.idToken,n,"internal-error");const a=Xi(i.idToken);M(a,n,"internal-error");const{sub:c}=a;return M(r.uid===c,n,"user-mismatch"),xt._forOperation(r,s,i)}catch(i){throw i?.code==="auth/user-not-found"&&Ve(n,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zc(r,e,t=!1){if(xe(r.app))return Promise.reject(Ye(r));const n="signIn",s=await $c(r,n,e),i=await xt._fromIdTokenResponse(r,n,s);return t||await r._updateCurrentUser(i.user),i}async function Lm(r,e){return zc(Ut(r),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hc(r){const e=Ut(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Mm(r,e,t){if(xe(r.app))return Promise.reject(Ye(r));const n=Ut(r),a=await Ci(n,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Nm).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&Hc(r),l}),c=await xt._fromIdTokenResponse(n,"signIn",a);return await n._updateCurrentUser(c.user),c}function xm(r,e,t){return xe(r.app)?Promise.reject(Ye(r)):Lm(oe(r),fn.credential(e,t)).catch(async n=>{throw n.code==="auth/password-does-not-meet-requirements"&&Hc(r),n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ue(){return window}function Hm(r){Ue().location.href=r}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ip=new sr(3e4,6e4);function du(){const r=Ue().___jsl;if(r?.H){for(const e of Object.keys(r.H))if(r.H[e].r=r.H[e].r||[],r.H[e].L=r.H[e].L||[],r.H[e].r=[...r.H[e].L],r.CP)for(let t=0;t<r.CP.length;t++)r.CP[t]=null}}function wp(r){return new Promise((e,t)=>{var n,s,i;function a(){du(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{du(),t(Fe(r,"network-request-failed"))},timeout:Ip.get()})}if(!((s=(n=Ue().gapi)===null||n===void 0?void 0:n.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=Ue().gapi)===null||i===void 0)&&i.load)a();else{const c=pm("iframefcb");return Ue()[c]=()=>{gapi.load?a():t(Fe(r,"network-request-failed"))},Bc(`${mm()}?onload=${c}`).catch(l=>t(l))}}).catch(e=>{throw Wr=null,e})}let Wr=null;function Ap(r){return Wr=Wr||wp(r),Wr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
