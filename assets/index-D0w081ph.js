 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bf(r){rn(new Mt("platform-logger",e=>new Xd(e),"PRIVATE")),rn(new Mt("heartbeat",e=>new xf(e),"PRIVATE")),gt(Ai,Ja,r),gt(Ai,Ja,"esm2017"),gt("fire-js","")}Bf("");var qf="firebase",Wf="11.2.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */gt(qf,Wf,"app");function Xi(r,e){var t={};for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&e.indexOf(n)<0&&(t[n]=r[n]);if(r!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,n=Object.getOwnPropertySymbols(r);s<n.length;s++)e.indexOf(n[s])<0&&Object.prototype.propertyIsEnumerable.call(r,n[s])&&(t[n[s]]=r[n[s]]);return t}function Ic(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const jf=Ic,Ac=new ir("auth","Firebase",Ic());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ts=new Qi("@firebase/auth");function $f(r,...e){ts.logLevel<=q.WARN&&ts.warn(`Auth (${dn}): ${r}`,...e)}function Wr(r,...e){ts.logLevel<=q.ERROR&&ts.error(`Auth (${dn}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wn(r){if(r)try{const e=new Date(Number(r));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function tm(r,e=!1){const t=oe(r),n=await t.getIdToken(e),s=to(n);M(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,a=i?.sign_in_provider;return{claims:s,token:n,authTime:Wn(mi(s.auth_time)),issuedAtTime:Wn(mi(s.iat)),expirationTime:Wn(mi(s.exp)),signInProvider:a||null,signInSecondFactor:i?.sign_in_second_factor||null}}function mi(r){return Number(r)*1e3}function to(r){const[e,t,n]=r.split(".");if(e===void 0||t===void 0||n===void 0)return Wr("JWT malformed, contained fewer than 3 sections"),null;try{const s=fc(t);return s?JSON.parse(s):(Wr("Failed to decode base64 JWT payload"),null)}catch(s){return Wr("Caught error parsing JWT payload as JSON",s?.toString()),null}}function su(r){const e=to(r);return M(e,"internal-error"),M(typeof e.exp<"u","internal-error"),M(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class as{constructor(e,t){this.position=e,this.inclusive=t}}function Du(r,e,t){let n=0;for(let s=0;s<r.position.length;s++){const i=e[s],a=r.position[s];if(i.field.isKeyField()?n=L.comparator(L.fromName(a.referenceValue),t.key):n=an(a,t.data.field(i.field)),i.dir==="desc"&&(n*=-1),n!==0)break}return n}function Nu(r,e){if(r===null)return e===null;if(e===null||r.inclusive!==e.inclusive||r.position.length!==e.position.length)return!1;for(let t=0;t<r.position.length;t++)if(!je(r.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fo(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:os(e)?"-0":e}}function Cl(r){return{integerValue:""+r}}function jg(r,e){return _g(e)?Cl(e):fo(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(e,t,n,s){this.targetId=e,this.fromCache=t,this.Wi=n,this.Gi=s}static zi(e,t){let n=W(),s=W();for(const i of t.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new vo(e,t.fromCache,n,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new N(S.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new N(S.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return j(this._lat,e._lat)||j(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jo(r,e,t){let n;return n=r?t&&(t.merge||t.mergeFields)?r.toFirestore(e,t):r.toFirestore(e):e,n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oE(r){r=Ne(r,Ae);const e=Ne(r.firestore,At);return jy(pr(e),r._key).then(t=>Rh(e,r,t))}class $o extends sE{constructor(e){super(),this.firestore=e}convertBytes(e){return new hn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Ae(this.firestore,null,t)}}function Ah(r){r=Ne(r,Pt);const e=Ne(r.firestore,At),t=pr(e),n=new $o(e);return Eh(r._query),$y(t,r._query).then(s=>new Ih(e,n,r,s))}function aE(r,e,t){r=Ne(r,Ae);const n=Ne(r.firestore,At),s=jo(r.converter,e,t);return zo(n,[Mo(Ls(n),"setDoc",r._key,s,r.converter!==null,t).toMutation(r._key,Pe.none())])}function uE(r,e){const t=Ne(r.firestore,At),n=Kn(r),s=jo(r.converter,e);return zo(t,[Mo(Ls(r.firestore),"addDoc",n._key,s,r.converter!==null,{}).toMutation(n._key,Pe.exists(!1))]).then(()=>n)}function cE(r,...e){var t,n,s;r=oe(r);let i={includeMetadataChanges:!1,source:"default"},a=0;typeof e[a]!="object"||ac(e[a])||(i=e[a],a++);const u={includeMetadataChanges:i.includeMetadataChanges,source:i.source};if(ac(e[a])){const y=e[a];e[a]=(t=y.next)===null||t===void 0?void 0:t.bind(y),e[a+1]=(n=y.error)===null||n===void 0?void 0:n.bind(y),e[a+2]=(s=y.complete)===null||s===void 0?void 0:s.bind(y)}let l,d,m;if(r instanceof Ae)d=Ne(r.firestore,At),m=ws(r._key.path),l={next:y=>{e[a]&&e[a](Rh(d,r,y))},error:e[a+1],complete:e[a+2]};else{const y=Ne(r,Pt);d=Ne(y.firestore,At),m=y._query;const I=new $o(d);l={next:b=>{e[a]&&e[a](new Ih(d,I,y,b))},error:e[a+1],complete:e[a+2]},Eh(r._query)}return function(I,b,P,O){const D=new No(O),$=new ko(b,D,P);return I.asyncQueue.enqueueAndForget(async()=>bo(await fs(I),$)),()=>{D.eu(),I.asyncQueue.enqueueAndForget(async()=>Co(await fs(I),$))}}(pr(d),m,u,l)}function zo(r,e){return function(n,s){const i=new Je;return n.asyncQueue.enqueueAndForget(async()=>Dy(await Wy(n),s,i)),i.promise}(pr(r),e)}function Rh(r,e,t){const n=t.docs.get(e._key),s=new $o(r);return new wh(r,s,e._key,n,new qn(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
