 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qd{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Yd(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function Yd(r){const e=r.getComponent();return e?.type==="VERSION"}const Ii="@firebase/app",Ka="0.10.18";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ai="[DEFAULT]",Rf={[Ii]:"fire-core",[Jd]:"fire-core-compat",[Zd]:"fire-analytics",[Xd]:"fire-analytics-compat",[tf]:"fire-app-check",[ef]:"fire-app-check-compat",[nf]:"fire-auth",[rf]:"fire-auth-compat",[sf]:"fire-rtdb",[of]:"fire-data-connect",[af]:"fire-rtdb-compat",[uf]:"fire-fn",[cf]:"fire-fn-compat",[lf]:"fire-iid",[hf]:"fire-iid-compat",[df]:"fire-fcm",[ff]:"fire-fcm-compat",[mf]:"fire-perf",[pf]:"fire-perf-compat",[gf]:"fire-rc",[_f]:"fire-rc-compat",[yf]:"fire-gcs",[Ef]:"fire-gcs-compat",[vf]:"fire-fst",[wf]:"fire-fst-compat",[Tf]:"fire-vertex","fire-js":"fire-js",[If]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xf(r){rn(new Lt("platform-logger",e=>new Qd(e),"PRIVATE")),rn(new Lt("heartbeat",e=>new Of(e),"PRIVATE")),gt(Ii,Ka,r),gt(Ii,Ka,"esm2017"),gt("fire-js","")}xf("");var Ff="firebase",Uf="11.2.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */gt(Ff,Uf,"app");function Qi(r,e){var t={};for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&e.indexOf(n)<0&&(t[n]=r[n]);if(r!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,n=Object.getOwnPropertySymbols(r);s<n.length;s++)e.indexOf(n[s])<0&&Object.prototype.propertyIsEnumerable.call(r,n[s])&&(t[n[s]]=r[n[s]]);return t}function wc(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Bf=wc,Ic=new nr("auth","Firebase",wc());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ts(r){var e;const t=r.auth,n=await r.getIdToken(),s=await Kn(r,Cc(t,{idToken:n}));M(s?.users.length,t,"internal-error");const i=s.users[0];r._notifyReloadListener(i);const a=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?Pc(i.providerUserInfo):[],c=nm(r.providerData,a),l=r.isAnonymous,d=!(r.email&&i.passwordHash)&&!c?.length,m=l?d:!1,y={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:c,metadata:new bi(i.createdAt,i.lastLoginAt),isAnonymous:m};Object.assign(r,y)}async function tm(r){const e=oe(r);await ts(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function nm(r,e){return[...r.filter(n=>!e.some(s=>s.providerId===n.providerId)),...e]}function Pc(r){return r.map(e=>{var{providerId:t}=e,n=Qi(e,["providerId"]);return{providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rm(r,e){const t=await Sc(r,{},async()=>{const n=rr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=r.config,a=bc(r,s,"/v1/token",`key=${i}`),c=await r._getAdditionalHeaders();return c["Content-Type"]="application/x-www-form-urlencoded",Rc.fetch()(a,{method:"POST",headers:c,body:n})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function sm(r,e){return St(r,"POST","/v2/accounts:revokeToken",Rt(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class am{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,t){const n=i=>new Promise((a,c)=>{try{const l=e(i);a(l)}catch(l){c(l)}});n.onAbort=t,this.queue.push(n);const s=this.queue.length-1;return()=>{this.queue[s]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const t=[];try{for(const n of this.queue)await n(e),n.onAbort&&t.push(n.onAbort)}catch(n){t.reverse();for(const s of t)try{s()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:n?.message})}}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function um(r,e={}){return St(r,"GET","/v2/passwordPolicy",Rt(r,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vm(r,e){const t=Ki(r,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(Xr(i,e??{}))return s;Ve(s,"already-initialized")}return t.initialize({options:e})}function Tm(r,e){const t=e?.persistence||[],n=(Array.isArray(t)?t:[t]).map(Qe);e?.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(n,e?.popupRedirectResolver)}function wm(r,e,t){const n=Ut(r);M(n._canInitEmulator,n,"emulator-config-failed"),M(/^https?:\/\//.test(e),n,"invalid-emulator-scheme");const s=!1,i=jc(e),{host:a,port:c}=Im(e),l=c===null?"":`:${c}`;n.config.emulator={url:`${i}//${a}${l}/`},n.settings.appVerificationDisabledForTesting=!0,n.emulatorConfig=Object.freeze({host:a,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),Am()}function jc(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function Im(r){const e=jc(r),t=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!t)return{host:"",port:null};const n=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(n);if(s){const i=s[1];return{host:i,port:au(n.substr(i.length+1))}}else{const[i,a]=n.split(":");return{host:i,port:au(a)}}}function au(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function Am(){function r(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eo{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Ge("not implemented")}_getIdTokenResponse(e){return Ge("not implemented")}_linkToIdToken(e,t){return Ge("not implemented")}_getReauthenticationResolver(e){return Ge("not implemented")}}async function Rm(r,e){return St(r,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sm(r,e){return ir(r,"POST","/v1/accounts:signInWithPassword",Rt(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bm(r,e){return ir(r,"POST","/v1/accounts:signInWithEmailLink",Rt(r,e))}async function Cm(r,e){return ir(r,"POST","/v1/accounts:signInWithEmailLink",Rt(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nm(r,e){return ir(r,"POST","/v1/accounts:signUp",Rt(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Om(r,e,t=!1){const{auth:n}=r;if(Fe(n.app))return Promise.reject(Ye(n));const s="reauthenticate";try{const i=await Kn(r,$c(n,s,e,r),t);M(i.idToken,n,"internal-error");const a=Xi(i.idToken);M(a,n,"internal-error");const{sub:c}=a;return M(r.uid===c,n,"user-mismatch"),xt._forOperation(r,s,i)}catch(i){throw i?.code==="auth/user-not-found"&&Ve(n,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zc(r,e,t=!1){if(Fe(r.app))return Promise.reject(Ye(r));const n="signIn",s=await $c(r,n,e),i=await xt._fromIdTokenResponse(r,n,s);return t||await r._updateCurrentUser(i.user),i}async function Lm(r,e){return zc(Ut(r),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hc(r){const e=Ut(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Mm(r,e,t){if(Fe(r.app))return Promise.reject(Ye(r));const n=Ut(r),a=await Ci(n,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Nm).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&Hc(r),l}),c=await xt._fromIdTokenResponse(n,"signIn",a);return await n._updateCurrentUser(c.user),c}function xm(r,e,t){return Fe(r.app)?Promise.reject(Ye(r)):Lm(oe(r),fn.credential(e,t)).catch(async n=>{throw n.code==="auth/password-does-not-meet-requirements"&&Hc(r),n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _s{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find(s=>s.isListeningto(e));if(t)return t;const n=new _s(e);return this.receivers.push(n),n}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:n,eventType:s,data:i}=t.data,a=this.handlersMap[s];if(!a?.size)return;t.ports[0].postMessage({status:"ack",eventId:n,eventType:s});const c=Array.from(a).map(async d=>d(t.origin,i)),l=await $m(c);t.ports[0].postMessage({status:"done",eventId:n,eventType:s,response:l})}_subscribe(e,t){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),(!t||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}_s.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zm{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,t,n=50){const s=typeof MessageChannel<"u"?new MessageChannel:null;if(!s)throw new Error("connection_unavailable");let i,a;return new Promise((c,l)=>{const d=no("",20);s.port1.start();const m=setTimeout(()=>{l(new Error("unsupported_event"))},n);a={messageChannel:s,onMessage(y){const I=y;if(I.data.eventId===d)switch(I.data.status){case"ack":clearTimeout(m),i=setTimeout(()=>{l(new Error("timeout"))},3e3);break;case"done":clearTimeout(i),c(I.data.response);break;default:clearTimeout(m),clearTimeout(i),l(new Error("invalid_response"));break}}},this.handlers.add(a),s.port1.addEventListener("message",a.onMessage),this.target.postMessage({eventType:e,eventId:d,data:t},[s.port2])}).finally(()=>{a&&this.removeMessageHandler(a)})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Be(){return window}function Hm(r){Be().location.href=r}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xc(){return typeof Be().WorkerGlobalScope<"u"&&typeof Be().importScripts=="function"}async function Gm(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Km(){var r;return((r=navigator?.serviceWorker)===null||r===void 0?void 0:r.controller)||null}function Qm(){return Xc()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nl{constructor(e,t,n,s,i=!1){this.auth=e,this.resolver=n,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(n){this.reject(n)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:s,tenantId:i,error:a,type:c}=e;if(a){this.reject(a);return}const l={auth:this.auth,requestUri:t,sessionId:n,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(c)(l))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return rp;case"linkViaPopup":case"linkViaRedirect":return ip;case"reauthViaPopup":case"reauthViaRedirect":return sp;default:Ve(this.auth,"internal-error")}}resolve(e){Ze(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Ze(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const op=new sr(2e3,1e4);class Jt extends nl{constructor(e,t,n,s,i){super(e,t,s,i),this.provider=n,this.authWindow=null,this.pollId=null,Jt.currentPopupAction&&Jt.currentPopupAction.cancel(),Jt.currentPopupAction=this}async executeNotNull(){const e=await this.execute();return M(e,this.auth,"internal-error"),e}async onExecution(){Ze(this.filter.length===1,"Popup operations only handle one event");const e=no();this.authWindow=await this.resolver._openPopup(this.auth,this.provider,this.filter[0],e),this.authWindow.associatedEvent=e,this.resolver._originValidation(this.auth).catch(t=>{this.reject(t)}),this.resolver._isIframeWebStorageSupported(this.auth,t=>{t||this.reject(Ue(this.auth,"web-storage-unsupported"))}),this.pollUserCancellation()}get eventId(){var e;return((e=this.authWindow)===null||e===void 0?void 0:e.associatedEvent)||null}cancel(){this.reject(Ue(this.auth,"cancelled-popup-request"))}cleanUp(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,Jt.currentPopupAction=null}pollUserCancellation(){const e=()=>{var t,n;if(!((n=(t=this.authWindow)===null||t===void 0?void 0:t.window)===null||n===void 0)&&n.closed){this.pollId=window.setTimeout(()=>{this.pollId=null,this.reject(Ue(this.auth,"popup-closed-by-user"))},8e3);return}this.pollId=window.setTimeout(e,op.get())};e()}}Jt.currentPopupAction=null;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ap="pendingRedirect",jr=new Map;class up extends nl{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=jr.get(this.auth._key());if(!e){try{const n=await cp(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(n)}catch(t){e=()=>Promise.reject(t)}jr.set(this.auth._key(),e)}return this.bypassAuthState||jr.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function cp(r,e){const t=dp(e),n=hp(r);if(!await n._isAvailable())return!1;const s=await n._get(t)==="true";return await n._remove(t),s}function lp(r,e){jr.set(r._key(),e)}function hp(r){return Qe(r._redirectPersistence)}function dp(r){return qr(ap,r.config.apiKey,r.name)}async function fp(r,e,t=!1){if(Fe(r.app))return Promise.reject(Ye(r));const n=Ut(r),s=np(n,e),a=await new up(n,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await n._persistUserIfCurrent(a.user),await n._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _p(r,e={}){return St(r,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wp=new sr(3e4,6e4);function du(){const r=Be().___jsl;if(r?.H){for(const e of Object.keys(r.H))if(r.H[e].r=r.H[e].r||[],r.H[e].L=r.H[e].L||[],r.H[e].r=[...r.H[e].L],r.CP)for(let t=0;t<r.CP.length;t++)r.CP[t]=null}}function Ip(r){return new Promise((e,t)=>{var n,s,i;function a(){du(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{du(),t(Ue(r,"network-request-failed"))},timeout:wp.get()})}if(!((s=(n=Be().gapi)===null||n===void 0?void 0:n.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=Be().gapi)===null||i===void 0)&&i.load)a();else{const c=pm("iframefcb");return Be()[c]=()=>{gapi.load?a():t(Ue(r,"network-request-failed"))},Bc(`${mm()}?onload=${c}`).catch(l=>t(l))}}).catch(e=>{throw Wr=null,e})}let Wr=null;function Ap(r){return Wr=Wr||Ip(r),Wr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rp=new sr(5e3,15e3),Sp="__/auth/iframe",bp="emulator/auth/iframe",Cp={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Pp=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function kp(r){const e=r.config;M(e.authDomain,r,"auth-domain-config-required");const t=e.emulator?Ji(e,bp):`https://${r.config.authDomain}/${Sp}`,n={apiKey:e.apiKey,appName:r.name,v:dn},s=Pp.get(r.config.apiHost);s&&(n.eid=s);const i=r._getFrameworks();return i.length&&(n.fw=i.join(",")),`${t}?${rr(n).slice(1)}`}async function Dp(r){const e=await Ap(r),t=Be().gapi;return M(t,r,"internal-error"),e.open({where:document.body,url:kp(r),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Cp,dontclear:!0},n=>new Promise(async(s,i)=>{await n.restyle({setHideOnLeave:!1});const a=Ue(r,"network-request-failed"),c=Be().setTimeout(()=>{i(a)},Rp.get());function l(){Be().clearTimeout(c),s(n)}n.ping(l).then(l,()=>{i(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Np={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Vp=500,Op=600,Lp="_blank",Mp="http://localhost";class fu{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function xp(r,e,t,n=Vp,s=Op){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),a=Math.max((window.screen.availWidth-n)/2,0).toString();let c="";const l=Object.assign(Object.assign({},Np),{width:n.toString(),height:s.toString(),top:i,left:a}),d=Te().toLowerCase();t&&(c=Vc(d)?Lp:t),Dc(d)&&(e=e||Mp,l.scrollbars="yes");const m=Object.entries(l).reduce((I,[S,P])=>`${I}${S}=${P},`,"");if(im(d)&&c!=="_self")return Fp(e||"",c),new fu(null);const y=window.open(e||"",c,m);M(y,r,"popup-blocked");try{y.focus()}catch{}return new fu(y)}function Fp(r,e){const t=document.createElement("a");t.href=r,t.target=e;const n=document.createEvent("MouseEvent");n.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(n)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hp(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Gp(r){rn(new Lt("auth",(e,{options:t})=>{const n=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:a,authDomain:c}=n.options;M(a&&!a.includes(":"),"invalid-api-key",{appName:n.name});const l={apiKey:a,authDomain:c,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Uc(r)},d=new hm(n,s,i,l);return Tm(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,n)=>{e.getProvider("auth-internal").initialize()})),rn(new Lt("auth-internal",e=>{const t=Ut(e.getProvider("auth").getImmediate());return(n=>new zp(n))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),gt(pu,gu,Hp(r)),gt(pu,gu,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kp=5*60,Qp=pc("authIdTokenMaxAge")||Kp;let _u=null;const Yp=r=>async e=>{const t=e&&await e.getIdTokenResult(),n=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Qp)return;const s=t?.token;_u!==s&&(_u=s,await fetch(r,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Jp(r=Ec()){const e=Ki(r,"auth");if(e.isInitialized())return e.getImmediate();const t=vm(r,{popupRedirectResolver:$p,persistence:[tp,Qc,Jc]}),n=pc("authTokenSyncURL");if(n&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(n,location.origin);if(location.origin===i.origin){const a=Yp(i.toString());Bm(t,a,()=>a(t.currentUser)),Um(t,c=>a(c))}}const s=fc("auth");return s&&wm(t,`http://${s}`),t}function Xp(){var r,e;return(e=(r=document.getElementsByTagName("head"))===null||r===void 0?void 0:r[0])!==null&&e!==void 0?e:document}dm({loadJS(r){return new Promise((e,t)=>{const n=document.createElement("script");n.setAttribute("src",r),n.onload=e,n.onerror=s=>{const i=Ue("internal-error");i.customData=s,t(i)},n.type="text/javascript",n.charset="UTF-8",Xp().appendChild(n)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Gp("Browser");var yu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var il,xn,ol,$r,ki,al,ul,cl;(function(){var r,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(o,u,h){return o==Array.prototype||o==Object.prototype||(o[u]=h.value),o};function t(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof Lr=="object"&&Lr];for(var u=0;u<o.length;++u){var h=o[u];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var n=t(this);function s(o,u){if(u)e:{var h=n;o=o.split(".");for(var f=0;f<o.length-1;f++){var w=o[f];if(!(w in h))break e;h=h[w]}o=o[o.length-1],f=h[o],u=u(f),u!=f&&u!=null&&e(h,o,{configurable:!0,writable:!0,value:u})}}function i(o,u){o instanceof String&&(o+="");var h=0,f=!1,w={next:function(){if(!f&&h<o.length){var R=h++;return{value:u(R,o[R]),done:!1}}return f=!0,{done:!0,value:void 0}}};return w[Symbol.iterator]=function(){return w},w}s("Array.prototype.values",function(o){return o||function(){return i(this,function(u,h){return h})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},c=this||self;function l(o){var u=typeof o;return u=u!="object"?u:o?Array.isArray(o)?"array":u:"null",u=="array"||u=="object"&&typeof o.length=="number"}function d(o){var u=typeof o;return u=="object"&&o!=null||u=="function"}function m(o,u,h){return o.call.apply(o.bind,arguments)}function y(o,u,h){if(!o)throw Error();if(2<arguments.length){var f=Array.prototype.slice.call(arguments,2);return function(){var w=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(w,f),o.apply(u,w)}}return function(){return o.apply(u,arguments)}}function I(o,u,h){return I=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?m:y,I.apply(null,arguments)}function S(o,u){var h=Array.prototype.slice.call(arguments,1);return function(){var f=h.slice();return f.push.apply(f,arguments),o.apply(this,f)}}function P(o,u){function h(){}h.prototype=u.prototype,o.aa=u.prototype,o.prototype=new h,o.prototype.constructor=o,o.Qb=function(f,w,R){for(var k=Array(arguments.length-2),Y=2;Y<arguments.length;Y++)k[Y-2]=arguments[Y];return u.prototype[w].apply(f,k)}}function O(o){const u=o.length;if(0<u){const h=Array(u);for(let f=0;f<u;f++)h[f]=o[f];return h}return[]}function D(o,u){for(let h=1;h<arguments.length;h++){const f=arguments[h];if(l(f)){const w=o.length||0,R=f.length||0;o.length=w+R;for(let k=0;k<R;k++)o[w+k]=f[k]}else o.push(f)}}class W{constructor(u,h){this.i=u,this.j=h,this.h=0,this.g=null}get(){let u;return 0<this.h?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function G(o){return/^[\s\xa0]*$/.test(o)}function K(){var o=c.navigator;return o&&(o=o.userAgent)?o:""}function te(o){return te[" "](o),o}te[" "]=function(){};var ke=K().indexOf("Gecko")!=-1&&!(K().toLowerCase().indexOf("webkit")!=-1&&K().indexOf("Edge")==-1)&&!(K().indexOf("Trident")!=-1||K().indexOf("MSIE")!=-1)&&K().indexOf("Edge")==-1;function ne(o,u,h){for(const f in o)u.call(h,o[f],f,o)}function v(o,u){for(const h in o)u.call(void 0,o[h],h,o)}function p(o){const u={};for(const h in o)u[h]=o[h];return u}const _="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function E(o,u){let h,f;for(let w=1;w<arguments.length;w++){f=arguments[w];for(h in f)o[h]=f[h];for(let R=0;R<_.length;R++)h=_[R],Object.prototype.hasOwnProperty.call(f,h)&&(o[h]=f[h])}}function T(o){var u=1;o=o.split(":");const h=[];for(;0<u&&o.length;)h.push(o.shift()),u--;return o.length&&h.push(o.join(":")),h}function A(o){c.setTimeout(()=>{throw o},0)}function g(){var o=Fs;let u=null;return o.g&&(u=o.g,o.g=o.g.next,o.g||(o.h=null),u.next=null),u}class $e{constructor(){this.h=this.g=null}add(u,h){const f=yn.get();f.set(u,h),this.h?this.h.next=f:this.g=f,this.h=f}}var yn=new W(()=>new Ih,o=>o.reset());class Ih{constructor(){this.next=this.g=this.h=null}set(u,h){this.h=u,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let En,vn=!1,Fs=new $e,Wo=()=>{const o=c.Promise.resolve(void 0);En=()=>{o.then(Ah)}};var Ah=()=>{for(var o;o=g();){try{o.h.call(o.g)}catch(h){A(h)}var u=yn;u.j(o),100>u.h&&(u.h++,o.next=u.g,u.g=o)}vn=!1};function rt(){this.s=this.s,this.C=this.C}rt.prototype.s=!1,rt.prototype.ma=function(){this.s||(this.s=!0,this.N())},rt.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function me(o,u){this.type=o,this.g=this.target=u,this.defaultPrevented=!1}me.prototype.h=function(){this.defaultPrevented=!0};var Rh=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var o=!1,u=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const h=()=>{};c.addEventListener("test",h,u),c.removeEventListener("test",h,u)}catch{}return o}();function Tn(o,u){if(me.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o){var h=this.type=o.type,f=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;if(this.target=o.target||o.srcElement,this.g=u,u=o.relatedTarget){if(ke){e:{try{te(u.nodeName);var w=!0;break e}catch{}w=!1}w||(u=null)}}else h=="mouseover"?u=o.fromElement:h=="mouseout"&&(u=o.toElement);this.relatedTarget=u,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=typeof o.pointerType=="string"?o.pointerType:Sh[o.pointerType]||"",this.state=o.state,this.i=o,o.defaultPrevented&&Tn.aa.h.call(this)}}P(Tn,me);var Sh={2:"touch",3:"pen",4:"mouse"};Tn.prototype.h=function(){Tn.aa.h.call(this);var o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var pr="closure_listenable_"+(1e6*Math.random()|0),bh=0;function Ch(o,u,h,f,w){this.listener=o,this.proxy=null,this.src=u,this.type=h,this.capture=!!f,this.ha=w,this.key=++bh,this.da=this.fa=!1}function gr(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function _r(o){this.src=o,this.g={},this.h=0}_r.prototype.add=function(o,u,h,f,w){var R=o.toString();o=this.g[R],o||(o=this.g[R]=[],this.h++);var k=Bs(o,u,f,w);return-1<k?(u=o[k],h||(u.fa=!1)):(u=new Ch(u,this.src,R,!!f,w),u.fa=h,o.push(u)),u};function Us(o,u){var h=u.type;if(h in o.g){var f=o.g[h],w=Array.prototype.indexOf.call(f,u,void 0),R;(R=0<=w)&&Array.prototype.splice.call(f,w,1),R&&(gr(u),o.g[h].length==0&&(delete o.g[h],o.h--))}}function Bs(o,u,h,f){for(var w=0;w<o.length;++w){var R=o[w];if(!R.da&&R.listener==u&&R.capture==!!h&&R.ha==f)return w}return-1}var qs="closure_lm_"+(1e6*Math.random()|0),js={};function $o(o,u,h,f,w){if(Array.isArray(u)){for(var R=0;R<u.length;R++)$o(o,u[R],h,f,w);return null}return h=Go(h),o&&o[pr]?o.K(u,h,d(f)?!!f.capture:!1,w):Ph(o,u,h,!1,f,w)}function Ph(o,u,h,f,w,R){if(!u)throw Error("Invalid event type");var k=d(w)?!!w.capture:!!w,Y=$s(o);if(Y||(o[qs]=Y=new _r(o)),h=Y.add(u,h,f,k,R),h.proxy)return h;if(f=kh(),h.proxy=f,f.src=o,f.listener=h,o.addEventListener)Rh||(w=k),w===void 0&&(w=!1),o.addEventListener(u.toString(),f,w);else if(o.attachEvent)o.attachEvent(Ho(u.toString()),f);else if(o.addListener&&o.removeListener)o.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return h}function kh(){function o(h){return u.call(o.src,o.listener,h)}const u=Dh;return o}function zo(o,u,h,f,w){if(Array.isArray(u))for(var R=0;R<u.length;R++)zo(o,u[R],h,f,w);else f=d(f)?!!f.capture:!!f,h=Go(h),o&&o[pr]?(o=o.i,u=String(u).toString(),u in o.g&&(R=o.g[u],h=Bs(R,h,f,w),-1<h&&(gr(R[h]),Array.prototype.splice.call(R,h,1),R.length==0&&(delete o.g[u],o.h--)))):o&&(o=$s(o))&&(u=o.g[u.toString()],o=-1,u&&(o=Bs(u,h,f,w)),(h=-1<o?u[o]:null)&&Ws(h))}function Ws(o){if(typeof o!="number"&&o&&!o.da){var u=o.src;if(u&&u[pr])Us(u.i,o);else{var h=o.type,f=o.proxy;u.removeEventListener?u.removeEventListener(h,f,o.capture):u.detachEvent?u.detachEvent(Ho(h),f):u.addListener&&u.removeListener&&u.removeListener(f),(h=$s(u))?(Us(h,o),h.h==0&&(h.src=null,u[qs]=null)):gr(o)}}}function Ho(o){return o in js?js[o]:js[o]="on"+o}function Dh(o,u){if(o.da)o=!0;else{u=new Tn(u,this);var h=o.listener,f=o.ha||o.src;o.fa&&Ws(o),o=h.call(f,u)}return o}function $s(o){return o=o[qs],o instanceof _r?o:null}var zs="__closure_events_fn_"+(1e9*Math.random()>>>0);function Go(o){return typeof o=="function"?o:(o[zs]||(o[zs]=function(u){return o.handleEvent(u)}),o[zs])}function pe(){rt.call(this),this.i=new _r(this),this.M=this,this.F=null}P(pe,rt),pe.prototype[pr]=!0,pe.prototype.removeEventListener=function(o,u,h,f){zo(this,o,u,h,f)};function we(o,u){var h,f=o.F;if(f)for(h=[];f;f=f.F)h.push(f);if(o=o.M,f=u.type||u,typeof u=="string")u=new me(u,o);else if(u instanceof me)u.target=u.target||o;else{var w=u;u=new me(f,o),E(u,w)}if(w=!0,h)for(var R=h.length-1;0<=R;R--){var k=u.g=h[R];w=yr(k,f,!0,u)&&w}if(k=u.g=o,w=yr(k,f,!0,u)&&w,w=yr(k,f,!1,u)&&w,h)for(R=0;R<h.length;R++)k=u.g=h[R],w=yr(k,f,!1,u)&&w}pe.prototype.N=function(){if(pe.aa.N.call(this),this.i){var o=this.i,u;for(u in o.g){for(var h=o.g[u],f=0;f<h.length;f++)gr(h[f]);delete o.g[u],o.h--}}this.F=null},pe.prototype.K=function(o,u,h,f){return this.i.add(String(o),u,!1,h,f)},pe.prototype.L=function(o,u,h,f){return this.i.add(String(o),u,!0,h,f)};function yr(o,u,h,f){if(u=o.i.g[String(u)],!u)return!0;u=u.concat();for(var w=!0,R=0;R<u.length;++R){var k=u[R];if(k&&!k.da&&k.capture==h){var Y=k.listener,le=k.ha||k.src;k.fa&&Us(o.i,k),w=Y.call(le,f)!==!1&&w}}return w&&!f.defaultPrevented}function Ko(o,u,h){if(typeof o=="function")h&&(o=I(o,h));else if(o&&typeof o.handleEvent=="function")o=I(o.handleEvent,o);else throw Error("Invalid listener argument");return 2147483647<Number(u)?-1:c.setTimeout(o,u||0)}function Qo(o){o.g=Ko(()=>{o.g=null,o.i&&(o.i=!1,Qo(o))},o.l);const u=o.h;o.h=null,o.m.apply(null,u)}class Nh extends rt{constructor(u,h){super(),this.m=u,this.l=h,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:Qo(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function wn(o){rt.call(this),this.h=o,this.g={}}P(wn,rt);var Yo=[];function Jo(o){ne(o.g,function(u,h){this.g.hasOwnProperty(h)&&Ws(u)},o),o.g={}}wn.prototype.N=function(){wn.aa.N.call(this),Jo(this)},wn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Hs=c.JSON.stringify,Vh=c.JSON.parse,Oh=class{stringify(o){return c.JSON.stringify(o,void 0)}parse(o){return c.JSON.parse(o,void 0)}};function Gs(){}Gs.prototype.h=null;function Xo(o){return o.h||(o.h=o.i())}function Zo(){}var In={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Ks(){me.call(this,"d")}P(Ks,me);function Qs(){me.call(this,"c")}P(Qs,me);var Pt={},ea=null;function Er(){return ea=ea||new pe}Pt.La="serverreachability";function ta(o){me.call(this,Pt.La,o)}P(ta,me);function An(o){const u=Er();we(u,new ta(u))}Pt.STAT_EVENT="statevent";function na(o,u){me.call(this,Pt.STAT_EVENT,o),this.stat=u}P(na,me);function Ie(o){const u=Er();we(u,new na(u,o))}Pt.Ma="timingevent";function ra(o,u){me.call(this,Pt.Ma,o),this.size=u}P(ra,me);function Rn(o,u){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){o()},u)}function Sn(){this.g=!0}Sn.prototype.xa=function(){this.g=!1};function Lh(o,u,h,f,w,R){o.info(function(){if(o.g)if(R)for(var k="",Y=R.split("&"),le=0;le<Y.length;le++){var H=Y[le].split("=");if(1<H.length){var ge=H[0];H=H[1];var _e=ge.split("_");k=2<=_e.length&&_e[1]=="type"?k+(ge+"="+H+"&"):k+(ge+"=redacted&")}}else k=null;else k=R;return"XMLHTTP REQ ("+f+") [attempt "+w+"]: "+u+`
`+h+`
`+k})}function Mh(o,u,h,f,w,R,k){o.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+w+"]: "+u+`
`+h+`
`+R+" "+k})}function Wt(o,u,h,f){o.info(function(){return"XMLHTTP TEXT ("+u+"): "+Fh(o,h)+(f?" "+f:"")})}function xh(o,u){o.info(function(){return"TIMEOUT: "+u})}Sn.prototype.info=function(){};function Fh(o,u){if(!o.g)return u;if(!u)return null;try{var h=JSON.parse(u);if(h){for(o=0;o<h.length;o++)if(Array.isArray(h[o])){var f=h[o];if(!(2>f.length)){var w=f[1];if(Array.isArray(w)&&!(1>w.length)){var R=w[0];if(R!="noop"&&R!="stop"&&R!="close")for(var k=1;k<w.length;k++)w[k]=""}}}}return Hs(h)}catch{return u}}var vr={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},sa={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},Ys;function Tr(){}P(Tr,Gs),Tr.prototype.g=function(){return new XMLHttpRequest},Tr.prototype.i=function(){return{}},Ys=new Tr;function st(o,u,h,f){this.j=o,this.i=u,this.l=h,this.R=f||1,this.U=new wn(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new ia}function ia(){this.i=null,this.g="",this.h=!1}var oa={},Js={};function Xs(o,u,h){o.L=1,o.v=Rr(ze(u)),o.m=h,o.P=!0,aa(o,null)}function aa(o,u){o.F=Date.now(),wr(o),o.A=ze(o.v);var h=o.A,f=o.R;Array.isArray(f)||(f=[String(f)]),Ta(h.i,"t",f),o.C=0,h=o.j.J,o.h=new ia,o.g=Ua(o.j,h?u:null,!o.m),0<o.O&&(o.M=new Nh(I(o.Y,o,o.g),o.O)),u=o.U,h=o.g,f=o.ca;var w="readystatechange";Array.isArray(w)||(w&&(Yo[0]=w.toString()),w=Yo);for(var R=0;R<w.length;R++){var k=$o(h,w[R],f||u.handleEvent,!1,u.h||u);if(!k)break;u.g[k.key]=k}u=o.H?p(o.H):{},o.m?(o.u||(o.u="POST"),u["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.A,o.u,o.m,u)):(o.u="GET",o.g.ea(o.A,o.u,null,u)),An(),Lh(o.i,o.u,o.A,o.l,o.R,o.m)}st.prototype.ca=function(o){o=o.target;const u=this.M;u&&He(o)==3?u.j():this.Y(o)},st.prototype.Y=function(o){try{if(o==this.g)e:{const _e=He(this.g);var u=this.g.Ba();const Ht=this.g.Z();if(!(3>_e)&&(_e!=3||this.g&&(this.h.h||this.g.oa()||Ca(this.g)))){this.J||_e!=4||u==7||(u==8||0>=Ht?An(3):An(2)),Zs(this);var h=this.g.Z();this.X=h;t:if(ua(this)){var f=Ca(this.g);o="";var w=f.length,R=He(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){kt(this),bn(this);var k="";break t}this.h.i=new c.TextDecoder}for(u=0;u<w;u++)this.h.h=!0,o+=this.h.i.decode(f[u],{stream:!(R&&u==w-1)});f.length=0,this.h.g+=o,this.C=0,k=this.h.g}else k=this.g.oa();if(this.o=h==200,Mh(this.i,this.u,this.A,this.l,this.R,_e,h),this.o){if(this.T&&!this.K){t:{if(this.g){var Y,le=this.g;if((Y=le.g?le.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!G(Y)){var H=Y;break t}}H=null}if(h=H)Wt(this.i,this.l,h,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,ei(this,h);else{this.o=!1,this.s=3,Ie(12),kt(this),bn(this);break e}}if(this.P){h=!0;let Ne;for(;!this.J&&this.C<k.length;)if(Ne=Uh(this,k),Ne==Js){_e==4&&(this.s=4,Ie(14),h=!1),Wt(this.i,this.l,null,"[Incomplete Response]");break}else if(Ne==oa){this.s=4,Ie(15),Wt(this.i,this.l,k,"[Invalid Chunk]"),h=!1;break}else Wt(this.i,this.l,Ne,null),ei(this,Ne);if(ua(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),_e!=4||k.length!=0||this.h.h||(this.s=1,Ie(16),h=!1),this.o=this.o&&h,!h)Wt(this.i,this.l,k,"[Invalid Chunked Response]"),kt(this),bn(this);else if(0<k.length&&!this.W){this.W=!0;var ge=this.j;ge.g==this&&ge.ba&&!ge.M&&(ge.j.info("Great, no buffering proxy detected. Bytes received: "+k.length),oi(ge),ge.M=!0,Ie(11))}}else Wt(this.i,this.l,k,null),ei(this,k);_e==4&&kt(this),this.o&&!this.J&&(_e==4?La(this.j,this):(this.o=!1,wr(this)))}else nd(this.g),h==400&&0<k.indexOf("Unknown SID")?(this.s=3,Ie(12)):(this.s=0,Ie(13)),kt(this),bn(this)}}}catch{}finally{}};function ua(o){return o.g?o.u=="GET"&&o.L!=2&&o.j.Ca:!1}function Uh(o,u){var h=o.C,f=u.indexOf(`
`,h);return f==-1?Js:(h=Number(u.substring(h,f)),isNaN(h)?oa:(f+=1,f+h>u.length?Js:(u=u.slice(f,f+h),o.C=f+h,u)))}st.prototype.cancel=function(){this.J=!0,kt(this)};function wr(o){o.S=Date.now()+o.I,ca(o,o.I)}function ca(o,u){if(o.B!=null)throw Error("WatchDog timer not null");o.B=Rn(I(o.ba,o),u)}function Zs(o){o.B&&(c.clearTimeout(o.B),o.B=null)}st.prototype.ba=function(){this.B=null;const o=Date.now();0<=o-this.S?(xh(this.i,this.A),this.L!=2&&(An(),Ie(17)),kt(this),this.s=2,bn(this)):ca(this,this.S-o)};function bn(o){o.j.G==0||o.J||La(o.j,o)}function kt(o){Zs(o);var u=o.M;u&&typeof u.ma=="function"&&u.ma(),o.M=null,Jo(o.U),o.g&&(u=o.g,o.g=null,u.abort(),u.ma())}function ei(o,u){try{var h=o.j;if(h.G!=0&&(h.g==o||ti(h.h,o))){if(!o.K&&ti(h.h,o)&&h.G==3){try{var f=h.Da.g.parse(u)}catch{f=null}if(Array.isArray(f)&&f.length==3){var w=f;if(w[0]==0){e:if(!h.u){if(h.g)if(h.g.F+3e3<o.F)Dr(h),Pr(h);else break e;ii(h),Ie(18)}}else h.za=w[1],0<h.za-h.T&&37500>w[2]&&h.F&&h.v==0&&!h.C&&(h.C=Rn(I(h.Za,h),6e3));if(1>=da(h.h)&&h.ca){try{h.ca()}catch{}h.ca=void 0}}else Nt(h,11)}else if((o.K||h.g==o)&&Dr(h),!G(u))for(w=h.Da.g.parse(u),u=0;u<w.length;u++){let H=w[u];if(h.T=H[0],H=H[1],h.G==2)if(H[0]=="c"){h.K=H[1],h.ia=H[2];const ge=H[3];ge!=null&&(h.la=ge,h.j.info("VER="+h.la));const _e=H[4];_e!=null&&(h.Aa=_e,h.j.info("SVER="+h.Aa));const Ht=H[5];Ht!=null&&typeof Ht=="number"&&0<Ht&&(f=1.5*Ht,h.L=f,h.j.info("backChannelRequestTimeoutMs_="+f)),f=h;const Ne=o.g;if(Ne){const Vr=Ne.g?Ne.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Vr){var R=f.h;R.g||Vr.indexOf("spdy")==-1&&Vr.indexOf("quic")==-1&&Vr.indexOf("h2")==-1||(R.j=R.l,R.g=new Set,R.h&&(ni(R,R.h),R.h=null))}if(f.D){const ai=Ne.g?Ne.g.getResponseHeader("X-HTTP-Session-Id"):null;ai&&(f.ya=ai,J(f.I,f.D,ai))}}h.G=3,h.l&&h.l.ua(),h.ba&&(h.R=Date.now()-o.F,h.j.info("Handshake RTT: "+h.R+"ms")),f=h;var k=o;if(f.qa=Fa(f,f.J?f.ia:null,f.W),k.K){fa(f.h,k);var Y=k,le=f.L;le&&(Y.I=le),Y.B&&(Zs(Y),wr(Y)),f.g=k}else Va(f);0<h.i.length&&kr(h)}else H[0]!="stop"&&H[0]!="close"||Nt(h,7);else h.G==3&&(H[0]=="stop"||H[0]=="close"?H[0]=="stop"?Nt(h,7):si(h):H[0]!="noop"&&h.l&&h.l.ta(H),h.v=0)}}An(4)}catch{}}var Bh=class{constructor(o,u){this.g=o,this.map=u}};function la(o){this.l=o||10,c.PerformanceNavigationTiming?(o=c.performance.getEntriesByType("navigation"),o=0<o.length&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function ha(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function da(o){return o.h?1:o.g?o.g.size:0}function ti(o,u){return o.h?o.h==u:o.g?o.g.has(u):!1}function ni(o,u){o.g?o.g.add(u):o.h=u}function fa(o,u){o.h&&o.h==u?o.h=null:o.g&&o.g.has(u)&&o.g.delete(u)}la.prototype.cancel=function(){if(this.i=ma(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function ma(o){if(o.h!=null)return o.i.concat(o.h.D);if(o.g!=null&&o.g.size!==0){let u=o.i;for(const h of o.g.values())u=u.concat(h.D);return u}return O(o.i)}function qh(o){if(o.V&&typeof o.V=="function")return o.V();if(typeof Map<"u"&&o instanceof Map||typeof Set<"u"&&o instanceof Set)return Array.from(o.values());if(typeof o=="string")return o.split("");if(l(o)){for(var u=[],h=o.length,f=0;f<h;f++)u.push(o[f]);return u}u=[],h=0;for(f in o)u[h++]=o[f];return u}function jh(o){if(o.na&&typeof o.na=="function")return o.na();if(!o.V||typeof o.V!="function"){if(typeof Map<"u"&&o instanceof Map)return Array.from(o.keys());if(!(typeof Set<"u"&&o instanceof Set)){if(l(o)||typeof o=="string"){var u=[];o=o.length;for(var h=0;h<o;h++)u.push(h);return u}u=[],h=0;for(const f in o)u[h++]=f;return u}}}function pa(o,u){if(o.forEach&&typeof o.forEach=="function")o.forEach(u,void 0);else if(l(o)||typeof o=="string")Array.prototype.forEach.call(o,u,void 0);else for(var h=jh(o),f=qh(o),w=f.length,R=0;R<w;R++)u.call(void 0,f[R],h&&h[R],o)}var ga=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Wh(o,u){if(o){o=o.split("&");for(var h=0;h<o.length;h++){var f=o[h].indexOf("="),w=null;if(0<=f){var R=o[h].substring(0,f);w=o[h].substring(f+1)}else R=o[h];u(R,w?decodeURIComponent(w.replace(/\+/g," ")):"")}}}function Dt(o){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,o instanceof Dt){this.h=o.h,Ir(this,o.j),this.o=o.o,this.g=o.g,Ar(this,o.s),this.l=o.l;var u=o.i,h=new kn;h.i=u.i,u.g&&(h.g=new Map(u.g),h.h=u.h),_a(this,h),this.m=o.m}else o&&(u=String(o).match(ga))?(this.h=!1,Ir(this,u[1]||"",!0),this.o=Cn(u[2]||""),this.g=Cn(u[3]||"",!0),Ar(this,u[4]),this.l=Cn(u[5]||"",!0),_a(this,u[6]||"",!0),this.m=Cn(u[7]||"")):(this.h=!1,this.i=new kn(null,this.h))}Dt.prototype.toString=function(){var o=[],u=this.j;u&&o.push(Pn(u,ya,!0),":");var h=this.g;return(h||u=="file")&&(o.push("//"),(u=this.o)&&o.push(Pn(u,ya,!0),"@"),o.push(encodeURIComponent(String(h)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.s,h!=null&&o.push(":",String(h))),(h=this.l)&&(this.g&&h.charAt(0)!="/"&&o.push("/"),o.push(Pn(h,h.charAt(0)=="/"?Hh:zh,!0))),(h=this.i.toString())&&o.push("?",h),(h=this.m)&&o.push("#",Pn(h,Kh)),o.join("")};function ze(o){return new Dt(o)}function Ir(o,u,h){o.j=h?Cn(u,!0):u,o.j&&(o.j=o.j.replace(/:$/,""))}function Ar(o,u){if(u){if(u=Number(u),isNaN(u)||0>u)throw Error("Bad port number "+u);o.s=u}else o.s=null}function _a(o,u,h){u instanceof kn?(o.i=u,Qh(o.i,o.h)):(h||(u=Pn(u,Gh)),o.i=new kn(u,o.h))}function J(o,u,h){o.i.set(u,h)}function Rr(o){return J(o,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),o}function Cn(o,u){return o?u?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function Pn(o,u,h){return typeof o=="string"?(o=encodeURI(o).replace(u,$h),h&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function $h(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var ya=/[#\/\?@]/g,zh=/[#\?:]/g,Hh=/[#\?]/g,Gh=/[#\?@]/g,Kh=/#/g;function kn(o,u){this.h=this.g=null,this.i=o||null,this.j=!!u}function it(o){o.g||(o.g=new Map,o.h=0,o.i&&Wh(o.i,function(u,h){o.add(decodeURIComponent(u.replace(/\+/g," ")),h)}))}r=kn.prototype,r.add=function(o,u){it(this),this.i=null,o=$t(this,o);var h=this.g.get(o);return h||this.g.set(o,h=[]),h.push(u),this.h+=1,this};function Ea(o,u){it(o),u=$t(o,u),o.g.has(u)&&(o.i=null,o.h-=o.g.get(u).length,o.g.delete(u))}function va(o,u){return it(o),u=$t(o,u),o.g.has(u)}r.forEach=function(o,u){it(this),this.g.forEach(function(h,f){h.forEach(function(w){o.call(u,w,f,this)},this)},this)},r.na=function(){it(this);const o=Array.from(this.g.values()),u=Array.from(this.g.keys()),h=[];for(let f=0;f<u.length;f++){const w=o[f];for(let R=0;R<w.length;R++)h.push(u[f])}return h},r.V=function(o){it(this);let u=[];if(typeof o=="string")va(this,o)&&(u=u.concat(this.g.get($t(this,o))));else{o=Array.from(this.g.values());for(let h=0;h<o.length;h++)u=u.concat(o[h])}return u},r.set=function(o,u){return it(this),this.i=null,o=$t(this,o),va(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[u]),this.h+=1,this},r.get=function(o,u){return o?(o=this.V(o),0<o.length?String(o[0]):u):u};function Ta(o,u,h){Ea(o,u),0<h.length&&(o.i=null,o.g.set($t(o,u),O(h)),o.h+=h.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],u=Array.from(this.g.keys());for(var h=0;h<u.length;h++){var f=u[h];const R=encodeURIComponent(String(f)),k=this.V(f);for(f=0;f<k.length;f++){var w=R;k[f]!==""&&(w+="="+encodeURIComponent(String(k[f]))),o.push(w)}}return this.i=o.join("&")};function $t(o,u){return u=String(u),o.j&&(u=u.toLowerCase()),u}function Qh(o,u){u&&!o.j&&(it(o),o.i=null,o.g.forEach(function(h,f){var w=f.toLowerCase();f!=w&&(Ea(this,f),Ta(this,w,h))},o)),o.j=u}function Yh(o,u){const h=new Sn;if(c.Image){const f=new Image;f.onload=S(ot,h,"TestLoadImage: loaded",!0,u,f),f.onerror=S(ot,h,"TestLoadImage: error",!1,u,f),f.onabort=S(ot,h,"TestLoadImage: abort",!1,u,f),f.ontimeout=S(ot,h,"TestLoadImage: timeout",!1,u,f),c.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=o}else u(!1)}function Jh(o,u){const h=new Sn,f=new AbortController,w=setTimeout(()=>{f.abort(),ot(h,"TestPingServer: timeout",!1,u)},1e4);fetch(o,{signal:f.signal}).then(R=>{clearTimeout(w),R.ok?ot(h,"TestPingServer: ok",!0,u):ot(h,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(w),ot(h,"TestPingServer: error",!1,u)})}function ot(o,u,h,f,w){try{w&&(w.onload=null,w.onerror=null,w.onabort=null,w.ontimeout=null),f(h)}catch{}}function Xh(){this.g=new Oh}function Zh(o,u,h){const f=h||"";try{pa(o,function(w,R){let k=w;d(w)&&(k=Hs(w)),u.push(f+R+"="+encodeURIComponent(k))})}catch(w){throw u.push(f+"type="+encodeURIComponent("_badmap")),w}}function Sr(o){this.l=o.Ub||null,this.j=o.eb||!1}P(Sr,Gs),Sr.prototype.g=function(){return new br(this.l,this.j)},Sr.prototype.i=function(o){return function(){return o}}({});function br(o,u){pe.call(this),this.D=o,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}P(br,pe),r=br.prototype,r.open=function(o,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=o,this.A=u,this.readyState=1,Nn(this)},r.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const u={headers:this.u,method:this.B,credentials:this.m,cache:void 0};o&&(u.body=o),(this.D||c).fetch(new Request(this.A,u)).then(this.Sa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Dn(this)),this.readyState=0},r.Sa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,Nn(this)),this.g&&(this.readyState=3,Nn(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;wa(this)}else o.text().then(this.Ra.bind(this),this.ga.bind(this))};function wa(o){o.j.read().then(o.Pa.bind(o)).catch(o.ga.bind(o))}r.Pa=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var u=o.value?o.value:new Uint8Array(0);(u=this.v.decode(u,{stream:!o.done}))&&(this.response=this.responseText+=u)}o.done?Dn(this):Nn(this),this.readyState==3&&wa(this)}},r.Ra=function(o){this.g&&(this.response=this.responseText=o,Dn(this))},r.Qa=function(o){this.g&&(this.response=o,Dn(this))},r.ga=function(){this.g&&Dn(this)};function Dn(o){o.readyState=4,o.l=null,o.j=null,o.v=null,Nn(o)}r.setRequestHeader=function(o,u){this.u.append(o,u)},r.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],u=this.h.entries();for(var h=u.next();!h.done;)h=h.value,o.push(h[0]+": "+h[1]),h=u.next();return o.join(`\r
`)};function Nn(o){o.onreadystatechange&&o.onreadystatechange.call(o)}Object.defineProperty(br.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(o){this.m=o?"include":"same-origin"}});function Ia(o){let u="";return ne(o,function(h,f){u+=f,u+=":",u+=h,u+=`\r
`}),u}function ri(o,u,h){e:{for(f in h){var f=!1;break e}f=!0}f||(h=Ia(h),typeof o=="string"?h!=null&&encodeURIComponent(String(h)):J(o,u,h))}function ee(o){pe.call(this),this.headers=new Map,this.o=o||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}P(ee,pe);var ed=/^https?$/i,td=["POST","PUT"];r=ee.prototype,r.Ha=function(o){this.J=o},r.ea=function(o,u,h,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);u=u?u.toUpperCase():"GET",this.D=o,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Ys.g(),this.v=this.o?Xo(this.o):Xo(Ys),this.g.onreadystatechange=I(this.Ea,this);try{this.B=!0,this.g.open(u,String(o),!0),this.B=!1}catch(R){Aa(this,R);return}if(o=h||"",h=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var w in f)h.set(w,f[w]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const R of f.keys())h.set(R,f.get(R));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(h.keys()).find(R=>R.toLowerCase()=="content-type"),w=c.FormData&&o instanceof c.FormData,!(0<=Array.prototype.indexOf.call(td,u,void 0))||f||w||h.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,k]of h)this.g.setRequestHeader(R,k);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{ba(this),this.u=!0,this.g.send(o),this.u=!1}catch(R){Aa(this,R)}};function Aa(o,u){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=u,o.m=5,Ra(o),Cr(o)}function Ra(o){o.A||(o.A=!0,we(o,"complete"),we(o,"error"))}r.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=o||7,we(this,"complete"),we(this,"abort"),Cr(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Cr(this,!0)),ee.aa.N.call(this)},r.Ea=function(){this.s||(this.B||this.u||this.j?Sa(this):this.bb())},r.bb=function(){Sa(this)};function Sa(o){if(o.h&&typeof a<"u"&&(!o.v[1]||He(o)!=4||o.Z()!=2)){if(o.u&&He(o)==4)Ko(o.Ea,0,o);else if(we(o,"readystatechange"),He(o)==4){o.h=!1;try{const k=o.Z();e:switch(k){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break e;default:u=!1}var h;if(!(h=u)){var f;if(f=k===0){var w=String(o.D).match(ga)[1]||null;!w&&c.self&&c.self.location&&(w=c.self.location.protocol.slice(0,-1)),f=!ed.test(w?w.toLowerCase():"")}h=f}if(h)we(o,"complete"),we(o,"success");else{o.m=6;try{var R=2<He(o)?o.g.statusText:""}catch{R=""}o.l=R+" ["+o.Z()+"]",Ra(o)}}finally{Cr(o)}}}}function Cr(o,u){if(o.g){ba(o);const h=o.g,f=o.v[0]?()=>{}:null;o.g=null,o.v=null,u||we(o,"ready");try{h.onreadystatechange=f}catch{}}}function ba(o){o.I&&(c.clearTimeout(o.I),o.I=null)}r.isActive=function(){return!!this.g};function He(o){return o.g?o.g.readyState:0}r.Z=function(){try{return 2<He(this)?this.g.status:-1}catch{return-1}},r.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.Oa=function(o){if(this.g){var u=this.g.responseText;return o&&u.indexOf(o)==0&&(u=u.substring(o.length)),Vh(u)}};function Ca(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.H){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function nd(o){const u={};o=(o.g&&2<=He(o)&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<o.length;f++){if(G(o[f]))continue;var h=T(o[f]);const w=h[0];if(h=h[1],typeof h!="string")continue;h=h.trim();const R=u[w]||[];u[w]=R,R.push(h)}v(u,function(f){return f.join(", ")})}r.Ba=function(){return this.m},r.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Vn(o,u,h){return h&&h.internalChannelParams&&h.internalChannelParams[o]||u}function Pa(o){this.Aa=0,this.i=[],this.j=new Sn,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Vn("failFast",!1,o),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Vn("baseRetryDelayMs",5e3,o),this.cb=Vn("retryDelaySeedMs",1e4,o),this.Wa=Vn("forwardChannelMaxRetries",2,o),this.wa=Vn("forwardChannelRequestTimeoutMs",2e4,o),this.pa=o&&o.xmlHttpFactory||void 0,this.Xa=o&&o.Tb||void 0,this.Ca=o&&o.useFetchStreams||!1,this.L=void 0,this.J=o&&o.supportsCrossDomainXhr||!1,this.K="",this.h=new la(o&&o.concurrentRequestLimit),this.Da=new Xh,this.P=o&&o.fastHandshake||!1,this.O=o&&o.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=o&&o.Rb||!1,o&&o.xa&&this.j.xa(),o&&o.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&o&&o.detectBufferingProxy||!1,this.ja=void 0,o&&o.longPollingTimeout&&0<o.longPollingTimeout&&(this.ja=o.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}r=Pa.prototype,r.la=8,r.G=1,r.connect=function(o,u,h,f){Ie(0),this.W=o,this.H=u||{},h&&f!==void 0&&(this.H.OSID=h,this.H.OAID=f),this.F=this.X,this.I=Fa(this,null,this.W),kr(this)};function si(o){if(ka(o),o.G==3){var u=o.U++,h=ze(o.I);if(J(h,"SID",o.K),J(h,"RID",u),J(h,"TYPE","terminate"),On(o,h),u=new st(o,o.j,u),u.L=2,u.v=Rr(ze(h)),h=!1,c.navigator&&c.navigator.sendBeacon)try{h=c.navigator.sendBeacon(u.v.toString(),"")}catch{}!h&&c.Image&&(new Image().src=u.v,h=!0),h||(u.g=Ua(u.j,null),u.g.ea(u.v)),u.F=Date.now(),wr(u)}xa(o)}function Pr(o){o.g&&(oi(o),o.g.cancel(),o.g=null)}function ka(o){Pr(o),o.u&&(c.clearTimeout(o.u),o.u=null),Dr(o),o.h.cancel(),o.s&&(typeof o.s=="number"&&c.clearTimeout(o.s),o.s=null)}function kr(o){if(!ha(o.h)&&!o.s){o.s=!0;var u=o.Ga;En||Wo(),vn||(En(),vn=!0),Fs.add(u,o),o.B=0}}function rd(o,u){return da(o.h)>=o.h.j-(o.s?1:0)?!1:o.s?(o.i=u.D.concat(o.i),!0):o.G==1||o.G==2||o.B>=(o.Va?0:o.Wa)?!1:(o.s=Rn(I(o.Ga,o,u),Ma(o,o.B)),o.B++,!0)}r.Ga=function(o){if(this.s)if(this.s=null,this.G==1){if(!o){this.U=Math.floor(1e5*Math.random()),o=this.U++;const w=new st(this,this.j,o);let R=this.o;if(this.S&&(R?(R=p(R),E(R,this.S)):R=this.S),this.m!==null||this.O||(w.H=R,R=null),this.P)e:{for(var u=0,h=0;h<this.i.length;h++){t:{var f=this.i[h];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break t}f=void 0}if(f===void 0)break;if(u+=f,4096<u){u=h;break e}if(u===4096||h===this.i.length-1){u=h+1;break e}}u=1e3}else u=1e3;u=Na(this,w,u),h=ze(this.I),J(h,"RID",o),J(h,"CVER",22),this.D&&J(h,"X-HTTP-Session-Id",this.D),On(this,h),R&&(this.O?u="headers="+encodeURIComponent(String(Ia(R)))+"&"+u:this.m&&ri(h,this.m,R)),ni(this.h,w),this.Ua&&J(h,"TYPE","init"),this.P?(J(h,"$req",u),J(h,"SID","null"),w.T=!0,Xs(w,h,null)):Xs(w,h,u),this.G=2}}else this.G==3&&(o?Da(this,o):this.i.length==0||ha(this.h)||Da(this))};function Da(o,u){var h;u?h=u.l:h=o.U++;const f=ze(o.I);J(f,"SID",o.K),J(f,"RID",h),J(f,"AID",o.T),On(o,f),o.m&&o.o&&ri(f,o.m,o.o),h=new st(o,o.j,h,o.B+1),o.m===null&&(h.H=o.o),u&&(o.i=u.D.concat(o.i)),u=Na(o,h,1e3),h.I=Math.round(.5*o.wa)+Math.round(.5*o.wa*Math.random()),ni(o.h,h),Xs(h,f,u)}function On(o,u){o.H&&ne(o.H,function(h,f){J(u,f,h)}),o.l&&pa({},function(h,f){J(u,f,h)})}function Na(o,u,h){h=Math.min(o.i.length,h);var f=o.l?I(o.l.Na,o.l,o):null;e:{var w=o.i;let R=-1;for(;;){const k=["count="+h];R==-1?0<h?(R=w[0].g,k.push("ofs="+R)):R=0:k.push("ofs="+R);let Y=!0;for(let le=0;le<h;le++){let H=w[le].g;const ge=w[le].map;if(H-=R,0>H)R=Math.max(0,w[le].g-100),Y=!1;else try{Zh(ge,k,"req"+H+"_")}catch{f&&f(ge)}}if(Y){f=k.join("&");break e}}}return o=o.i.splice(0,h),u.D=o,f}function Va(o){if(!o.g&&!o.u){o.Y=1;var u=o.Fa;En||Wo(),vn||(En(),vn=!0),Fs.add(u,o),o.v=0}}function ii(o){return o.g||o.u||3<=o.v?!1:(o.Y++,o.u=Rn(I(o.Fa,o),Ma(o,o.v)),o.v++,!0)}r.Fa=function(){if(this.u=null,Oa(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var o=2*this.R;this.j.info("BP detection timer enabled: "+o),this.A=Rn(I(this.ab,this),o)}},r.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Ie(10),Pr(this),Oa(this))};function oi(o){o.A!=null&&(c.clearTimeout(o.A),o.A=null)}function Oa(o){o.g=new st(o,o.j,"rpc",o.Y),o.m===null&&(o.g.H=o.o),o.g.O=0;var u=ze(o.qa);J(u,"RID","rpc"),J(u,"SID",o.K),J(u,"AID",o.T),J(u,"CI",o.F?"0":"1"),!o.F&&o.ja&&J(u,"TO",o.ja),J(u,"TYPE","xmlhttp"),On(o,u),o.m&&o.o&&ri(u,o.m,o.o),o.L&&(o.g.I=o.L);var h=o.g;o=o.ia,h.L=1,h.v=Rr(ze(u)),h.m=null,h.P=!0,aa(h,o)}r.Za=function(){this.C!=null&&(this.C=null,Pr(this),ii(this),Ie(19))};function Dr(o){o.C!=null&&(c.clearTimeout(o.C),o.C=null)}function La(o,u){var h=null;if(o.g==u){Dr(o),oi(o),o.g=null;var f=2}else if(ti(o.h,u))h=u.D,fa(o.h,u),f=1;else return;if(o.G!=0){if(u.o)if(f==1){h=u.m?u.m.length:0,u=Date.now()-u.F;var w=o.B;f=Er(),we(f,new ra(f,h)),kr(o)}else Va(o);else if(w=u.s,w==3||w==0&&0<u.X||!(f==1&&rd(o,u)||f==2&&ii(o)))switch(h&&0<h.length&&(u=o.h,u.i=u.i.concat(h)),w){case 1:Nt(o,5);break;case 4:Nt(o,10);break;case 3:Nt(o,6);break;default:Nt(o,2)}}}function Ma(o,u){let h=o.Ta+Math.floor(Math.random()*o.cb);return o.isActive()||(h*=2),h*u}function Nt(o,u){if(o.j.info("Error code "+u),u==2){var h=I(o.fb,o),f=o.Xa;const w=!f;f=new Dt(f||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||Ir(f,"https"),Rr(f),w?Yh(f.toString(),h):Jh(f.toString(),h)}else Ie(2);o.G=0,o.l&&o.l.sa(u),xa(o),ka(o)}r.fb=function(o){o?(this.j.info("Successfully pinged google.com"),Ie(2)):(this.j.info("Failed to ping google.com"),Ie(1))};function xa(o){if(o.G=0,o.ka=[],o.l){const u=ma(o.h);(u.length!=0||o.i.length!=0)&&(D(o.ka,u),D(o.ka,o.i),o.h.i.length=0,O(o.i),o.i.length=0),o.l.ra()}}function Fa(o,u,h){var f=h instanceof Dt?ze(h):new Dt(h);if(f.g!="")u&&(f.g=u+"."+f.g),Ar(f,f.s);else{var w=c.location;f=w.protocol,u=u?u+"."+w.hostname:w.hostname,w=+w.port;var R=new Dt(null);f&&Ir(R,f),u&&(R.g=u),w&&Ar(R,w),h&&(R.l=h),f=R}return h=o.D,u=o.ya,h&&u&&J(f,h,u),J(f,"VER",o.la),On(o,f),f}function Ua(o,u,h){if(u&&!o.J)throw Error("Can't create secondary domain capable XhrIo object.");return u=o.Ca&&!o.pa?new ee(new Sr({eb:h})):new ee(o.pa),u.Ha(o.J),u}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function Ba(){}r=Ba.prototype,r.ua=function(){},r.ta=function(){},r.sa=function(){},r.ra=function(){},r.isActive=function(){return!0},r.Na=function(){};function Nr(){}Nr.prototype.g=function(o,u){return new be(o,u)};function be(o,u){pe.call(this),this.g=new Pa(u),this.l=o,this.h=u&&u.messageUrlParams||null,o=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(o?o["X-WebChannel-Content-Type"]=u.messageContentType:o={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.va&&(o?o["X-WebChannel-Client-Profile"]=u.va:o={"X-WebChannel-Client-Profile":u.va}),this.g.S=o,(o=u&&u.Sb)&&!G(o)&&(this.g.m=o),this.v=u&&u.supportsCrossDomainXhr||!1,this.u=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!G(u)&&(this.g.D=u,o=this.h,o!==null&&u in o&&(o=this.h,u in o&&delete o[u])),this.j=new zt(this)}P(be,pe),be.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},be.prototype.close=function(){si(this.g)},be.prototype.o=function(o){var u=this.g;if(typeof o=="string"){var h={};h.__data__=o,o=h}else this.u&&(h={},h.__data__=Hs(o),o=h);u.i.push(new Bh(u.Ya++,o)),u.G==3&&kr(u)},be.prototype.N=function(){this.g.l=null,delete this.j,si(this.g),delete this.g,be.aa.N.call(this)};function qa(o){Ks.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var u=o.__sm__;if(u){e:{for(const h in u){o=h;break e}o=void 0}(this.i=o)&&(o=this.i,u=u!==null&&o in u?u[o]:void 0),this.data=u}else this.data=o}P(qa,Ks);function ja(){Qs.call(this),this.status=1}P(ja,Qs);function zt(o){this.g=o}P(zt,Ba),zt.prototype.ua=function(){we(this.g,"a")},zt.prototype.ta=function(o){we(this.g,new qa(o))},zt.prototype.sa=function(o){we(this.g,new ja)},zt.prototype.ra=function(){we(this.g,"b")},Nr.prototype.createWebChannel=Nr.prototype.g,be.prototype.send=be.prototype.o,be.prototype.open=be.prototype.m,be.prototype.close=be.prototype.close,cl=function(){return new Nr},ul=function(){return Er()},al=Pt,ki={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},vr.NO_ERROR=0,vr.TIMEOUT=8,vr.HTTP_ERROR=6,$r=vr,sa.COMPLETE="complete",ol=sa,Zo.EventType=In,In.OPEN="a",In.CLOSE="b",In.ERROR="c",In.MESSAGE="d",pe.prototype.listen=pe.prototype.K,xn=Zo,ee.prototype.listenOnce=ee.prototype.L,ee.prototype.getLastError=ee.prototype.Ka,ee.prototype.getLastErrorCode=ee.prototype.Ba,ee.prototype.getStatus=ee.prototype.Z,ee.prototype.getResponseJson=ee.prototype.Oa,ee.prototype.getResponseText=ee.prototype.oa,ee.prototype.send=ee.prototype.ea,ee.prototype.setWithCredentials=ee.prototype.Ha,il=ee}).apply(typeof Lr<"u"?Lr:typeof self<"u"?self:typeof window<"u"?window:{});const Eu="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ft=new Hi("@firebase/firestore");function Gt(){return Ft.logLevel}function N(r,...e){if(Ft.logLevel<=B.DEBUG){const t=e.map(so);Ft.debug(`Firestore (${mn}): ${r}`,...t)}}function et(r,...e){if(Ft.logLevel<=B.ERROR){const t=e.map(so);Ft.error(`Firestore (${mn}): ${r}`,...t)}}function sn(r,...e){if(Ft.logLevel<=B.WARN){const t=e.map(so);Ft.warn(`Firestore (${mn}): ${r}`,...t)}}function so(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pg(r){let e="";for(let t=0;t<r.length;t++)e.length>0&&(e=vu(e)),e=gg(r.get(t),e);return vu(e)}function gg(r,e){let t=e;const n=r.length;for(let s=0;s<n;s++){const i=r.charAt(s);switch(i){case"\0":t+="";break;case"":t+="";break;default:t+=i}}return t}function vu(r){return r+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se{constructor(e){this.value=e}static empty(){return new Se({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!Hr(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=jn(t)}setAll(e){let t=de.emptyPath(),n={},s=[];e.forEach((a,c)=>{if(!t.isImmediateParentOf(c)){const l=this.getFieldsMap(t);this.applyChanges(l,n,s),n={},s=[],t=c.popLast()}a?n[c.lastSegment()]=jn(a):s.push(c.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,n,s)}delete(e){const t=this.field(e.popLast());Hr(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return We(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let s=t.mapValue.fields[e.get(n)];Hr(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,n){bt(t,(s,i)=>e[s]=i);for(const s of n)delete e[s]}clone(){return new Se(jn(this.value))}}function ml(r){const e=[];return bt(r.fields,(t,n)=>{const s=new de([t]);if(Hr(n)){const i=ml(n.mapValue).fields;if(i.length===0)e.push(s);else for(const a of i)e.push(s.child(a))}else e.push(s)}),new Ce(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class os{constructor(e,t){this.position=e,this.inclusive=t}}function Cu(r,e,t){let n=0;for(let s=0;s<r.position.length;s++){const i=e[s],a=r.position[s];if(i.field.isKeyField()?n=L.comparator(L.fromName(a.referenceValue),t.key):n=an(a,t.data.field(i.field)),i.dir==="desc"&&(n*=-1),n!==0)break}return n}function Pu(r,e){if(r===null)return e===null;if(e===null||r.inclusive!==e.inclusive||r.position.length!==e.position.length)return!1;for(let t=0;t<r.position.length;t++)if(!We(r.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function co(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:is(e)?"-0":e}}function bl(r){return{integerValue:""+r}}function Bg(r,e){return mg(e)?bl(e):co(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T_{constructor(){this.ln=new w_}addToCollectionParentIndex(e,t){return this.ln.add(t),C.resolve()}getCollectionParents(e,t){return C.resolve(this.ln.getEntries(t))}addFieldIndex(e,t){return C.resolve()}deleteFieldIndex(e,t){return C.resolve()}deleteAllFieldIndexes(e){return C.resolve()}createTargetIndexes(e,t){return C.resolve()}getDocumentsMatchingTarget(e,t){return C.resolve(null)}getIndexType(e,t){return C.resolve(0)}getFieldIndexes(e,t){return C.resolve([])}getNextCollectionGroupToUpdate(e){return C.resolve(null)}getMinOffset(e,t){return C.resolve(Et.min())}getMinOffsetFromCollectionGroup(e,t){return C.resolve(Et.min())}updateCollectionGroup(e,t,n){return C.resolve()}updateIndexEntries(e,t){return C.resolve()}}class w_{constructor(){this.index={}}add(e){const t=e.lastSegment(),n=e.popLast(),s=this.index[t]||new ue(X.comparator),i=!s.has(n);return this.index[t]=s.add(n),i}has(e){const t=e.lastSegment(),n=e.popLast(),s=this.index[t];return s&&s.has(n)}getEntries(e){return(this.index[e]||new ue(X.comparator)).toArray()}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class P_{constructor(e,t,n,s){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=n,this.indexManager=s}getDocument(e,t){let n=null;return this.documentOverlayCache.getOverlay(e,t).next(s=>(n=s,this.remoteDocumentCache.getEntry(e,t))).next(s=>(n!==null&&zn(n.mutation,s,Ce.empty(),ae.now()),s))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(n=>this.getLocalViewOfDocuments(e,n,q()).next(()=>n))}getLocalViewOfDocuments(e,t,n=q()){const s=Ot();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,n).next(i=>{let a=Fn();return i.forEach((c,l)=>{a=a.insert(c,l.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const n=Ot();return this.populateOverlays(e,n,t).next(()=>this.computeViews(e,t,n,q()))}populateOverlays(e,t,n){const s=[];return n.forEach(i=>{t.has(i)||s.push(i)}),this.documentOverlayCache.getOverlays(e,s).next(i=>{i.forEach((a,c)=>{t.set(a,c)})})}computeViews(e,t,n,s){let i=tt();const a=$n(),c=function(){return $n()}();return t.forEach((l,d)=>{const m=n.get(d.key);s.has(d.key)&&(m===void 0||m.mutation instanceof Ct)?i=i.insert(d.key,d):m!==void 0?(a.set(d.key,m.mutation.getFieldMask()),zn(m.mutation,d,m.mutation.getFieldMask(),ae.now())):a.set(d.key,Ce.empty())}),this.recalculateAndSaveOverlays(e,i).next(l=>(l.forEach((d,m)=>a.set(d,m)),t.forEach((d,m)=>{var y;return c.set(d,new C_(m,(y=a.get(d))!==null&&y!==void 0?y:null))}),c))}recalculateAndSaveOverlays(e,t){const n=$n();let s=new Z((a,c)=>a-c),i=q();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const c of a)c.keys().forEach(l=>{const d=t.get(l);if(d===null)return;let m=n.get(l)||Ce.empty();m=c.applyToLocalView(d,m),n.set(l,m);const y=(s.get(c.batchId)||q()).add(l);s=s.insert(c.batchId,y)})}).next(()=>{const a=[],c=s.getReverseIterator();for(;c.hasNext();){const l=c.getNext(),d=l.key,m=l.value,y=Sl();m.forEach(I=>{if(!i.has(I)){const S=Nl(t.get(I),n.get(I));S!==null&&y.set(I,S),i=i.add(I)}}),a.push(this.documentOverlayCache.saveOverlays(e,d,y))}return C.waitFor(a)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(n=>this.recalculateAndSaveOverlays(e,n))}getDocumentsMatchingQuery(e,t,n,s){return function(a){return L.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Tl(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,n,s):this.getDocumentsMatchingCollectionQuery(e,t,n,s)}getNextDocuments(e,t,n,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,n,s).next(i=>{const a=s-i.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,n.largestBatchId,s-i.size):C.resolve(Ot());let c=-1,l=i;return a.next(d=>C.forEach(d,(m,y)=>(c<y.largestBatchId&&(c=y.largestBatchId),i.get(m)?C.resolve():this.remoteDocumentCache.getEntry(e,m).next(I=>{l=l.insert(m,I)}))).next(()=>this.populateOverlays(e,d,i)).next(()=>this.computeViews(e,l,d,q())).next(m=>({batchId:c,changes:Rl(m)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new L(t)).next(n=>{let s=Fn();return n.isFoundDocument()&&(s=s.insert(n.key,n)),s})}getDocumentsMatchingCollectionGroupQuery(e,t,n,s){const i=t.collectionGroup;let a=Fn();return this.indexManager.getCollectionParents(e,i).next(c=>C.forEach(c,l=>{const d=function(y,I){return new ur(I,null,y.explicitOrderBy.slice(),y.filters.slice(),y.limit,y.limitType,y.startAt,y.endAt)}(t,l.child(i));return this.getDocumentsMatchingCollectionQuery(e,d,n,s).next(m=>{m.forEach((y,I)=>{a=a.insert(y,I)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,n,s){let i;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,n.largestBatchId).next(a=>(i=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,n,i,s))).next(a=>{i.forEach((l,d)=>{const m=d.getKey();a.get(m)===null&&(a=a.insert(m,ve.newInvalidDocument(m)))});let c=Fn();return a.forEach((l,d)=>{const m=i.get(l);m!==void 0&&zn(m.mutation,d,Ce.empty(),ae.now()),As(t,d)&&(c=c.insert(l,d))}),c})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class D_{constructor(){this.overlays=new Z(L.comparator),this.dr=new Map}getOverlay(e,t){return C.resolve(this.overlays.get(t))}getOverlays(e,t){const n=Ot();return C.forEach(t,s=>this.getOverlay(e,s).next(i=>{i!==null&&n.set(s,i)})).next(()=>n)}saveOverlays(e,t,n){return n.forEach((s,i)=>{this.Tt(e,t,i)}),C.resolve()}removeOverlaysForBatchId(e,t,n){const s=this.dr.get(n);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.dr.delete(n)),C.resolve()}getOverlaysForCollection(e,t,n){const s=Ot(),i=t.length+1,a=new L(t.child("")),c=this.overlays.getIteratorFrom(a);for(;c.hasNext();){const l=c.getNext().value,d=l.getKey();if(!t.isPrefixOf(d.path))break;d.path.length===i&&l.largestBatchId>n&&s.set(l.getKey(),l)}return C.resolve(s)}getOverlaysForCollectionGroup(e,t,n,s){let i=new Z((d,m)=>d-m);const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===t&&d.largestBatchId>n){let m=i.get(d.largestBatchId);m===null&&(m=Ot(),i=i.insert(d.largestBatchId,m)),m.set(d.getKey(),d)}}const c=Ot(),l=i.getIterator();for(;l.hasNext()&&(l.getNext().value.forEach((d,m)=>c.set(d,m)),!(c.size()>=s)););return C.resolve(c)}Tt(e,t,n){const s=this.overlays.get(n.key);if(s!==null){const a=this.dr.get(s.largestBatchId).delete(n.key);this.dr.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(n.key,new Yg(t,n));let i=this.dr.get(t);i===void 0&&(i=q(),this.dr.set(t,i)),this.dr.set(t,i.add(n.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hy=/^__.*__$/;class Gy{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return this.fieldMask!==null?new Ct(e,this.data,this.fieldMask,t,this.fieldTransforms):new cr(e,this.data,t,this.fieldTransforms)}}class dh{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new Ct(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function fh(r){switch(r){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw x()}}class No{constructor(e,t,n,s,i,a){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=s,i===void 0&&this.Fu(),this.fieldTransforms=i||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Mu(){return this.settings.Mu}xu(e){return new No(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Ou(e){var t;const n=(t=this.path)===null||t===void 0?void 0:t.child(e),s=this.xu({path:n,Nu:!1});return s.Bu(e),s}Lu(e){var t;const n=(t=this.path)===null||t===void 0?void 0:t.child(e),s=this.xu({path:n,Nu:!1});return s.Fu(),s}ku(e){return this.xu({path:void 0,Nu:!0})}qu(e){return ms(e,this.settings.methodName,this.settings.Qu||!1,this.path,this.settings.Ku)}contains(e){return this.fieldMask.find(t=>e.isPrefixOf(t))!==void 0||this.fieldTransforms.find(t=>e.isPrefixOf(t.field))!==void 0}Fu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Bu(this.path.get(e))}Bu(e){if(e.length===0)throw this.qu("Document fields must not be empty");if(fh(this.Mu)&&Hy.test(e))throw this.qu('Document fields cannot begin and end with "__"')}}class Ky{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||Cs(e)}$u(e,t,n,s=!1){return new No({Mu:e,methodName:t,Ku:n,path:de.emptyPath(),Nu:!1,Qu:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Ls(r){const e=r._freezeSettings(),t=Cs(r._databaseId);return new Ky(r._databaseId,!!e.ignoreUndefinedProperties,t)}function Vo(r,e,t,n,s,i={}){const a=r.$u(i.merge||i.mergeFields?2:0,e,t,s);Lo("Data must be an object, but it was:",a,n);const c=mh(n,a);let l,d;if(i.merge)l=new Ce(a.fieldMask),d=a.fieldTransforms;else if(i.mergeFields){const m=[];for(const y of i.mergeFields){const I=zi(e,y,t);if(!a.contains(I))throw new V(b.INVALID_ARGUMENT,`Field '${I}' is specified in your field mask but missing from your input data.`);gh(m,I)||m.push(I)}l=new Ce(m),d=a.fieldTransforms.filter(y=>l.covers(y.field))}else l=null,d=a.fieldTransforms;return new Gy(new Se(c),l,d)}class Ms extends Os{_toFieldTransform(e){if(e.Mu!==2)throw e.Mu===1?e.qu(`${this._methodName}() can only appear at the top level of your update data`):e.qu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Ms}}class Oo extends Os{_toFieldTransform(e){return new Wg(e.path,new Zn)}isEqual(e){return e instanceof Oo}}function Qy(r,e,t,n){const s=r.$u(1,e,t);Lo("Data must be an object, but it was:",s,n);const i=[],a=Se.empty();bt(n,(l,d)=>{const m=Mo(e,l,t);d=oe(d);const y=s.Lu(m);if(d instanceof Ms)i.push(m);else{const I=mr(d,y);I!=null&&(i.push(m),a.set(m,I))}});const c=new Ce(i);return new dh(a,c,s.fieldTransforms)}function Yy(r,e,t,n,s,i){const a=r.$u(1,e,t),c=[zi(e,n,t)],l=[s];if(i.length%2!=0)throw new V(b.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let I=0;I<i.length;I+=2)c.push(zi(e,i[I])),l.push(i[I+1]);const d=[],m=Se.empty();for(let I=c.length-1;I>=0;--I)if(!gh(d,c[I])){const S=c[I];let P=l[I];P=oe(P);const O=a.Lu(S);if(P instanceof Ms)d.push(S);else{const D=mr(P,O);D!=null&&(d.push(S),m.set(S,D))}}const y=new Ce(d);return new dh(m,y,a.fieldTransforms)}function Jy(r,e,t,n=!1){return mr(t,r.$u(n?4:3,e))}function mr(r,e){if(ph(r=oe(r)))return Lo("Unsupported field value:",e,r),mh(r,e);if(r instanceof Os)return function(n,s){if(!fh(s.Mu))throw s.qu(`${n._methodName}() can only be used with update() and set()`);if(!s.path)throw s.qu(`${n._methodName}() is not currently supported inside arrays`);const i=n._toFieldTransform(s);i&&s.fieldTransforms.push(i)}(r,e),null;if(r===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),r instanceof Array){if(e.settings.Nu&&e.Mu!==4)throw e.qu("Nested arrays are not supported");return function(n,s){const i=[];let a=0;for(const c of n){let l=mr(c,s.ku(a));l==null&&(l={nullValue:"NULL_VALUE"}),i.push(l),a++}return{arrayValue:{values:i}}}(r,e)}return function(n,s){if((n=oe(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return Bg(s.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const i=ae.fromDate(n);return{timestampValue:cs(s.serializer,i)}}if(n instanceof ae){const i=new ae(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:cs(s.serializer,i)}}if(n instanceof ko)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof hn)return{bytesValue:xl(s.serializer,n._byteString)};if(n instanceof Ae){const i=s.databaseId,a=n.firestore._databaseId;if(!a.isEqual(i))throw s.qu(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${i.projectId}/${i.database}`);return{referenceValue:mo(n.firestore._databaseId||s.databaseId,n._key.path)}}if(n instanceof Do)return function(a,c){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:a.toArray().map(l=>{if(typeof l!="number")throw c.qu("VectorValues must only contain numeric values.");return co(c.serializer,l)})}}}}}}(n,s);throw s.qu(`Unsupported field value: ${Ds(n)}`)}(r,e)}function mh(r,e){const t={};return dl(r)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):bt(r,(n,s)=>{const i=mr(s,e.Ou(n));i!=null&&(t[n]=i)}),{mapValue:{fields:t}}}function ph(r){return!(typeof r!="object"||r===null||r instanceof Array||r instanceof Date||r instanceof ae||r instanceof ko||r instanceof hn||r instanceof Ae||r instanceof Os||r instanceof Do)}function Lo(r,e,t){if(!ph(t)||!function(s){return typeof s=="object"&&s!==null&&(Object.getPrototypeOf(s)===Object.prototype||Object.getPrototypeOf(s)===null)}(t)){const n=Ds(t);throw n==="an object"?e.qu(r+" a custom object"):e.qu(r+" "+n)}}function zi(r,e,t){if((e=oe(e))instanceof Vs)return e._internalPath;if(typeof e=="string")return Mo(r,e);throw ms("Field path arguments must be of type string or ",r,!1,void 0,t)}const Xy=new RegExp("[~\\*/\\[\\]]");function Mo(r,e,t){if(e.search(Xy)>=0)throw ms(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,r,!1,void 0,t);try{return new Vs(...e.split("."))._internalPath}catch{throw ms(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,r,!1,void 0,t)}}function ms(r,e,t,n,s){const i=n&&!n.isEmpty(),a=s!==void 0;let c=`Function ${e}() called with invalid data`;t&&(c+=" (via `toFirestore()`)"),c+=". ";let l="";return(i||a)&&(l+=" (found",i&&(l+=` in field ${n}`),a&&(l+=` in document ${s}`),l+=")"),new V(b.INVALID_ARGUMENT,c+r+l)}function gh(r,e){return r.some(t=>t.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rE(r){r=De(r,Ae);const e=De(r.firestore,At);return By(fr(e),r._key).then(t=>wh(e,r,t))}class qo extends tE{constructor(e){super(),this.firestore=e}convertBytes(e){return new hn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Ae(this.firestore,null,t)}}function sE(r){r=De(r,jt);const e=De(r.firestore,At),t=fr(e),n=new qo(e);return yh(r._query),qy(t,r._query).then(s=>new Th(e,n,r,s))}function iE(r,e,t){r=De(r,Ae);const n=De(r.firestore,At),s=Bo(r.converter,e,t);return jo(n,[Vo(Ls(n),"setDoc",r._key,s,r.converter!==null,t).toMutation(r._key,Pe.none())])}function oE(r,e){const t=De(r.firestore,At),n=Hn(r),s=Bo(r.converter,e);return jo(t,[Vo(Ls(r.firestore),"addDoc",n._key,s,r.converter!==null,{}).toMutation(n._key,Pe.exists(!1))]).then(()=>n)}function aE(r,...e){var t,n,s;r=oe(r);let i={includeMetadataChanges:!1,source:"default"},a=0;typeof e[a]!="object"||sc(e[a])||(i=e[a],a++);const c={includeMetadataChanges:i.includeMetadataChanges,source:i.source};if(sc(e[a])){const y=e[a];e[a]=(t=y.next)===null||t===void 0?void 0:t.bind(y),e[a+1]=(n=y.error)===null||n===void 0?void 0:n.bind(y),e[a+2]=(s=y.complete)===null||s===void 0?void 0:s.bind(y)}let l,d,m;if(r instanceof Ae)d=De(r.firestore,At),m=ws(r._key.path),l={next:y=>{e[a]&&e[a](wh(d,r,y))},error:e[a+1],complete:e[a+2]};else{const y=De(r,jt);d=De(y.firestore,At),m=y._query;const I=new qo(d);l={next:S=>{e[a]&&e[a](new Th(d,I,y,S))},error:e[a+1],complete:e[a+2]},yh(r._query)}return function(I,S,P,O){const D=new Po(O),W=new bo(S,D,P);return I.asyncQueue.enqueueAndForget(async()=>Ao(await fs(I),W)),()=>{D.eu(),I.asyncQueue.enqueueAndForget(async()=>Ro(await fs(I),W))}}(fr(d),m,c,l)}function jo(r,e){return function(n,s){const i=new Je;return n.asyncQueue.enqueueAndForget(async()=>Cy(await Uy(n),s,i)),i.promise}(fr(r),e)}function wh(r,e,t){const n=t.docs.get(e._key),s=new qo(r);return new vh(r,s,e._key,n,new Bn(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function cc(r){return fr(r=De(r,At)),new uE(r,e=>jo(r,e))}(function(e,t=!0){(function(s){mn=s})(dn),rn(new Lt("firestore",(n,{instanceIdentifier:s,options:i})=>{const a=n.getProvider("app").getImmediate(),c=new At(new tg(n.getProvider("auth-internal")),new ig(n.getProvider("app-check-internal")),function(d,m){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new V(b.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Jn(d.options.projectId,m)}(a,s),a);return i=Object.assign({useFetchStreams:t},i),c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),gt(Eu,"4.7.6",e),gt(Eu,"4.7.6","esm2017")})();let vi,dt,Me;try{const r={apiKey:"AIzaSyB1dlHRhLA71PxCgVLjOieUcUF22DWx6zY",authDomain:"autonomy-heroes.firebaseapp.com",projectId:"autonomy-heroes",storageBucket:"autonomy-heroes.firebasestorage.app",messagingSenderId:"266526530869",appId:"1:266526530869:web:ea95143735be497ca8007c",measurementId:"G-70PG5B4S39"},e=["apiKey","authDomain","projectId"];for(const t of e)if(!r[t])throw new Error(`Missing required Firebase config key: ${t}`);vi=yc(r),dt=Jp(vi),Me=$y(vi)}catch(r){throw console.error("Firebase initialization failed:",r),new Error("Failed to initialize Firebase: "+r.message)}class z{static formatDate(e){if(!(e instanceof Date))throw new Error("Invalid date object");return e.toISOString().split("T")[0]}static parseDate(e){const t=new Date(e);if(isNaN(t))throw new Error("Invalid date string");return t}static normalizeDate(e){const t=new Date(e);return t.setHours(0,0,0,0),new Date(t.getFullYear(),t.getMonth(),t.getDate())}static getDateDifference(e,t){const n=this.normalizeDate(e),s=this.normalizeDate(t);return Math.ceil((s-n)/(1e3*60*60*24))}static isDateInRange(e,t,n){const s=this.normalizeDate(new Date(e)),i=this.normalizeDate(new Date(t)),a=this.normalizeDate(new Date(n));return s>=i&&s<=a}static getCurrentWeek(){return this.getWeekStart(new Date)}static getWeekStart(e){const t=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),n=t.getUTCDay(),s=n===0?-6:1-n;return t.setUTCDate(t.getUTCDate()+s),t}static getWeekEnd(e){const t=this.getWeekStart(e),n=new Date(t);return n.setUTCDate(n.getUTCDate()+6),n.setUTCHours(23,59,59,999),n}static isSameWeek(e,t){const n=this.getWeekStart(new Date(e)),s=this.getWeekStart(new Date(t));return this.isSameDay(n,s)}static isSameDay(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}static getStartOfDay(e){const t=new Date(e);return t.setHours(0,0,0,0),t}static getEndOfDay(e){const t=new Date(e);return t.setHours(23,59,59,999),t}static getWeekNumber(e){const t=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())),n=t.getUTCDay()||7;t.setUTCDate(t.getUTCDate()+4-n);const s=new Date(Date.UTC(t.getUTCFullYear(),0,1));return Math.ceil(((t-s)/864e5+1)/7)}static formatDateForDisplay(e){return e.toLocaleDateString("en-US",{weekday:"long",year:"numeric",month:"long",day:"numeric"})}}class Le{static createElement(e,t={}){const n=document.createElement(e);return t.text&&(n.textContent=t.text),t.className&&(n.className=t.className),t.attributes&&Object.keys(t.attributes).forEach(s=>{n.setAttribute(s,t.attributes[s])}),n}static removeAllChildren(e){for(;e.firstChild;)e.removeChild(e.firstChild)}static appendChildren(e,t){t.forEach(n=>e.appendChild(n))}static toggleVisibility(e,t,n="hidden"){t?e.classList.remove(n):e.classList.add(n)}}class cE{constructor(){try{this.verifyRequiredElements(),this.initializeState(),this.bindEvents(),this.setupAuthPersistence()}catch(e){throw console.error("Error initializing AuthManager:",e),this.showError("Failed to initialize authentication"),e}}verifyRequiredElements(){const e=["authContainer","calendarContainer","userEmail","loginTab","registerTab","loginForm","registerForm","authErrorContainer","authErrorMessage","logoutBtn","appLoading"],t=e.filter(n=>!document.getElementById(n));if(t.length>0)throw new Error(`Missing required elements: ${t.join(", ")}`);this.elements=e.reduce((n,s)=>(n[s]=document.getElementById(s),n),{})}initializeState(){this.state={isLoading:!1,currentUser:null,isRegistering:!1}}bindEvents(){this.elements.loginTab.addEventListener("click",()=>this.switchTab("login")),this.elements.registerTab.addEventListener("click",()=>this.switchTab("register")),this.elements.loginForm.addEventListener("submit",e=>this.handleLogin(e)),this.elements.registerForm.addEventListener("submit",e=>this.handleRegister(e)),this.elements.logoutBtn.addEventListener("click",()=>this.handleLogout())}async setupAuthPersistence(){try{await Fm(dt,Qc),dt.onAuthStateChanged(e=>this.handleAuthStateChange(e))}catch(e){console.error("Error setting auth persistence:",e),this.showError("Failed to initialize authentication")}}async handleAuthStateChange(e){this.state.currentUser=e,this.elements.appLoading.style.display="none",e?(this.elements.authContainer.classList.remove("active"),this.elements.calendarContainer.classList.add("active"),this.elements.userEmail.textContent=e.email,this.clearError()):(this.elements.authContainer.classList.add("active"),this.elements.calendarContainer.classList.remove("active"),this.elements.userEmail.textContent="")}switchTab(e){this.state.isRegistering=e==="register",this.elements.loginTab.classList.toggle("active",!this.state.isRegistering),this.elements.registerTab.classList.toggle("active",this.state.isRegistering),this.elements.loginForm.classList.toggle("active",!this.state.isRegistering),this.elements.registerForm.classList.toggle("active",this.state.isRegistering),this.clearError()}async handleLogin(e){if(e.preventDefault(),this.state.isLoading)return;const t=e.target,n=t.email.value.trim(),s=t.password.value;this.setLoading(!0);try{await xm(dt,n,s),t.reset(),this.clearError()}catch(i){console.error("Login error:",i),this.showError(this.getAuthErrorMessage(i))}finally{this.setLoading(!1)}}async handleRegister(e){if(e.preventDefault(),this.state.isLoading)return;const t=e.target,n=t.email.value.trim(),s=t.password.value,i=t.firstName.value.trim(),a=t.lastName.value.trim();this.setLoading(!0);try{const c=await Mm(dt,n,s),l=Hn(Qr(Me,"users"),c.user.uid);await iE(l,{firstName:i,lastName:a,email:n,role:"worker",createdAt:Xt(),updatedAt:Xt()}),t.reset(),this.clearError()}catch(c){console.error("Registration error:",c),this.showError(this.getAuthErrorMessage(c))}finally{this.setLoading(!1)}}async handleLogout(){if(!this.state.isLoading){this.setLoading(!0);try{await qm(dt),this.clearError()}catch(e){console.error("Logout error:",e),this.showError("Failed to log out. Please try again.")}finally{this.setLoading(!1)}}}setLoading(e){this.state.isLoading=e,[...this.elements.loginForm.querySelectorAll("button"),...this.elements.registerForm.querySelectorAll("button"),this.elements.logoutBtn].forEach(n=>{n.disabled=e})}showError(e){this.elements.authErrorContainer.style.display="block",this.elements.authErrorMessage.textContent=e}clearError(){this.elements.authErrorContainer.style.display="none",this.elements.authErrorMessage.textContent=""}getAuthErrorMessage(e){switch(e.code){case"auth/user-not-found":case"auth/wrong-password":return"Invalid email or password";case"auth/email-already-in-use":return"Email is already registered";case"auth/weak-password":return"Password should be at least 6 characters";case"auth/invalid-email":return"Invalid email address";default:return"An error occurred. Please try again."}}}class lE{constructor(e){if(!e)throw new Error("TimeTrackingCalendar requires a valid userId");if(!dt?.currentUser)throw new Error("User must be authenticated");this.userId=e,this.timeEntries=new Map,this.currentWeek=new Date,this.isOnline=navigator.onLine,this.isLoading=!1,this.abortController=new AbortController,this.eventListeners=new Map,this.handlePrevWeek=this.handlePrevWeek.bind(this),this.handleNextWeek=this.handleNextWeek.bind(this),this.handleDayClick=this.handleDayClick.bind(this),this.handleSubmitWeek=this.handleSubmitWeek.bind(this),this.handleApproveWeek=this.handleApproveWeek.bind(this),this.handleTodayClick=this.handleTodayClick.bind(this),this.initializeNetworkListeners()}addEventListenerSafe(e,t,n,s={}){e&&(e.addEventListener(t,n,s),this.eventListeners.set(`${e.id||"unknown"}-${t}`,{element:e,type:t,fn:n}))}initializeNetworkListeners(){const e=()=>{this.isOnline=!0,this.isLoading||this.loadData()},t=()=>{this.isOnline=!1,this.showNotification("warning","You are offline. Changes will be saved locally.")};this.addEventListenerSafe(window,"online",e),this.addEventListenerSafe(window,"offline",t)}async initializeCalendar(e){try{if(this.isLoading=!0,this.abortController.abort(),this.abortController=new AbortController,this.container=document.getElementById(e),!this.container)throw new Error(`Container element '${e}' not found`);await this.cleanup(),await this.setupUserRole(),this.setupCalendarStructure(),await this.loadData(),this.setupRealTimeUpdates(),this.attachEventListeners()}catch(t){throw console.error("Calendar initialization failed:",t),this.showError("Failed to initialize calendar"),t}finally{this.isLoading=!1}}async setupUserRole(){try{const e=Hn(Me,"users",this.userId),t=await rE(e);if(t.exists()){const n=t.data();this.userRole=n.role||"worker",this.isManager=this.userRole==="manager"||this.userRole==="admin"}else this.userRole="worker",this.isManager=!1}catch(e){console.error("Error fetching user role:",e),this.userRole="worker",this.isManager=!1}}setupCalendarStructure(){z.getWeekStart(this.currentWeek);const e=Le.createElement("div",{className:"calendar-inner"});e.innerHTML=`
    ...
    `,Le.removeAllChildren(this.container),this.container.appendChild(e),this.container.appendChild(t),this.elements={grid:e.querySelector(".days"),monthDisplay:e.querySelector(".current-month"),prevButton:e.querySelector(".prev-month"),nextButton:e.querySelector(".next-month"),submitButton:t.querySelector(".submit-week"),approveButton:t.querySelector(".approve-week"),totalHours:t.querySelector(".total-hours span"),regularHours:t.querySelector(".regular-hours span"),overtimeHours:t.querySelector(".overtime-hours span"),ptoHours:t.querySelector(".pto-hours span"),unpaidHours:t.querySelector(".unpaid-hours span")},this.elements.submitButton&&this.elements.submitButton.addEventListener("click",this.handleSubmitWeek),this.render()}async loadData(){if(!this.isLoading){this.isLoading=!0,this.setLoading(!0);try{const e=Qr(Me,"timeEntries"),t=ic(e,oc("userId","==",this.userId)),n=await sE(t);this.timeEntries.clear(),n.forEach(s=>{const i=s.data();this.timeEntries.set(i.date,{...i,id:s.id})}),this.render()}catch(e){if(e.name==="AbortError"){console.log("Data loading aborted");return}throw console.error("Error loading data:",e),this.showError("Failed to load calendar data"),e}finally{this.isLoading=!1,this.setLoading(!1)}}}setupRealTimeUpdates(){if(this.unsubscribe&&this.unsubscribe(),!this.isOnline)return;const e=Qr(Me,"timeEntries"),t=ic(e,oc("userId","==",this.userId));this.unsubscribe=aE(t,n=>{n.docChanges().forEach(s=>{const i=s.doc.data();s.type==="added"||s.type==="modified"?this.timeEntries.set(i.date,{...i,id:s.doc.id}):s.type==="removed"&&this.timeEntries.delete(i.date)}),this.render()},n=>{console.error("Error in real-time updates:",n),this.showNotification("error","Failed to get real-time updates")})}getWeekSummary(){const e=z.getWeekStart(this.currentWeek),t=z.getWeekEnd(this.currentWeek);console.log("Week Summary Calculation:",{weekStart:e.toISOString(),weekEnd:t.toISOString(),entries:Array.from(this.timeEntries.entries()).map(([s,i])=>({date:s,isInRange:z.isDateInRange(new Date(s),e,t),hours:i.hours,isSubmitted:i.isSubmitted}))});let n={totalHours:0,regularHours:0,overtimeHours:0,ptoHours:0,unpaidLeaveHours:0,isSubmitted:!1,isApproved:!1};for(const s of this.timeEntries.values()){const i=new Date(s.date);if(console.log("Processing entry:",{date:s.date,entryDate:i.toISOString(),isInRange:z.isDateInRange(i,e,t),hours:s.hours,isSubmitted:s.isSubmitted}),z.isDateInRange(i,e,t)){if(s.isTimeOff)s.timeOffType==="paid"?(n.ptoHours+=s.hours||0,n.totalHours+=s.hours||0):n.unpaidLeaveHours+=s.hours||0;else{const a=s.hours||0;n.totalHours+=a,a>8?(n.regularHours+=8,n.overtimeHours+=a-8):n.regularHours+=a}s.isSubmitted&&(n.isSubmitted=!0),s.isApproved&&(n.isApproved=!0)}}return n}render(){if(!this.elements?.grid)return;const e=new Date(this.currentWeek.getFullYear(),this.currentWeek.getMonth(),1),t=new Date(this.currentWeek.getFullYear(),this.currentWeek.getMonth()+1,0),n=z.getStartOfDay(new Date);Le.removeAllChildren(this.elements.grid);const s=(e.getDay()+6)%7,i=t.getDate();for(let a=0;a<s;a++){const c=Le.createElement("div",{className:"calendar-day empty"});this.elements.grid.appendChild(c)}for(let a=1;a<=i;a++){const c=new Date(this.currentWeek.getFullYear(),this.currentWeek.getMonth(),a),l=z.formatDate(c),d=this.timeEntries.get(l);console.log("Day Status:",{date:l,entry:d,isSubmitted:d?.isSubmitted,hasEntry:!!d});const m=z.isSameDay(z.getStartOfDay(c),n),y=z.isSameWeek(c,n),I=c<z.getStartOfDay(n),S=c>z.getEndOfDay(n),P=Le.createElement("div",{className:`calendar-day
                    ${m?"today":""}
                    ${y?"current-week":""}
                    ${I?"past":""}
                    ${S?"future":""}
...
${!d.isTimeOff&&d.hours>8?`<span class="badge overtime" 
    ...
    `:""}`,P.addEventListener("click",()=>this.handleDayClick(c,d)),this.elements.grid.appendChild(P)}this.updateControls()}updateControls(){const e=this.getWeekSummary(),t=z.isSameWeek(this.currentWeek,new Date);this.elements.totalHours&&(this.elements.totalHours.textContent=(e.totalHours||0).toFixed(1)),this.elements.regularHours&&(this.elements.regularHours.textContent=(e.regularHours||0).toFixed(1)),this.elements.overtimeHours&&(this.elements.overtimeHours.textContent=(e.overtimeHours||0).toFixed(1)),this.elements.ptoHours&&(this.elements.ptoHours.textContent=(e.ptoHours||0).toFixed(1)),this.elements.unpaidHours&&(this.elements.unpaidHours.textContent=(e.unpaidLeaveHours||0).toFixed(1)),this.elements.monthDisplay&&(this.elements.monthDisplay.textContent=this.currentWeek.toLocaleString("default",{month:"long",year:"numeric"})),this.elements.submitButton&&(this.elements.submitButton.disabled=!t||e.isSubmitted,this.elements.submitButton.replaceWith(this.elements.submitButton.cloneNode(!0)),this.elements.submitButton=this.container.querySelector(".submit-week"),e.isSubmitted||!t?this.elements.submitButton.addEventListener("click",()=>{this.showNotification("warning","This week has been submitted. Contact your manager for changes.")}):this.elements.submitButton.addEventListener("click",this.handleSubmitWeek)),this.elements.approveButton&&(this.elements.approveButton.disabled=!this.isManager||!e.isSubmitted||e.isApproved)}handleDayClick(e,t){if(!z.isSameWeek(e,new Date)){this.showNotification("warning","Can only add entries for the current week");return}const n=z.getWeekStart(e),s=z.getWeekEnd(e);if(Array.from(this.timeEntries.values()).some(c=>{const l=new Date(c.date);return l>=n&&l<=s&&c.isSubmitted})){this.showNotification("warning","This week has been submitted. Contact your manager for changes.");return}const a=new CustomEvent("dayClick",{bubbles:!0,detail:{date:e,entry:t}});this.container.dispatchEvent(a)}handleTodayClick(){this.currentWeek=new Date,this.render()}handlePrevWeek(){this.currentWeek.setMonth(this.currentWeek.getMonth()-1),this.render()}handleNextWeek(){this.currentWeek.setMonth(this.currentWeek.getMonth()+1),this.render()}async handleSubmitWeek(){if(this.getWeekSummary().isSubmitted){this.showNotification("warning","Week has already been submitted");return}if(!this.timeEntries.size){this.showNotification("warning","Please add time entries before submitting");return}if(await this.showConfirmDialog({title:"Submit Week",message:"Are you sure you want to submit this week? This action cannot be undone.",confirmText:"Submit",cancelText:"Cancel"}))try{const n=z.getWeekStart(this.currentWeek),s=z.getWeekEnd(this.currentWeek);console.log("Week boundaries:",{weekStart:n,weekEnd:s,currentWeek:this.currentWeek});const i=Array.from(this.timeEntries.entries()).filter(([c,l])=>{const d=new Date(c),m=z.isDateInRange(d,n,s);return console.log("Entry Check:",{dateStr:c,isInRange:m,entryDate:d,weekStart:n,weekEnd:s}),m&&!l.isSubmitted});if(i.length===0){this.showNotification("warning","No entries to submit");return}const a=cc(Me);for(const[c,l]of i){const d=Hn(Me,"timeEntries",l.id);a.update(d,{isSubmitted:!0,submittedAt:Xt()})}await a.commit(),await this.loadData(),this.showNotification("success","Week submitted successfully")}catch(n){console.error("Error submitting week:",n),this.showNotification("error","Failed to submit week")}}showConfirmDialog({title:e,message:t,confirmText:n="Confirm",cancelText:s="Cancel"}){return new Promise(i=>{const a=Le.createElement("div",{className:"modal-overlay",attributes:{style:"position: fixed !important; z-index: 999999999 !important"}}),c=Le.createElement("div",{className:"confirmation-dialog",attributes:{style:"position: fixed !important; z-index: 999999999 !important"}});c.innerHTML=`
            ...
            `,document.body.appendChild(a),document.body.appendChild(c);const l=c.querySelector("#confirmBtn"),d=c.querySelector("#cancelBtn"),m=y=>{a.remove(),c.remove(),i(y)};l.addEventListener("click",()=>m(!0)),d.addEventListener("click",()=>m(!1)),a.addEventListener("click",()=>m(!1)),document.addEventListener("keydown",function y(I){I.key==="Escape"&&(document.removeEventListener("keydown",y),m(!1))})})}getEntryState(e,t){return{isToday:z.isSameDay(z.getStartOfDay(e),new Date),isCurrentWeek:z.isSameWeek(e,new Date),isPast:e<z.getStartOfDay(new Date),isFuture:e>z.getEndOfDay(new Date),hasEntry:!!t,isSubmitted:t?.isSubmitted||!1,isApproved:t?.isApproved||!1,hoursType:this.getHoursType(t)}}getHoursType(e){return e?e.isTimeOff?e.timeOffType:e.hours>8?"overtime":"regular":"none"}updateSubmittedStatus(){if(this.getWeekSummary().isSubmitted){const t=Le.createElement("div",{className:"week-submitted-message",innerHTML:`
